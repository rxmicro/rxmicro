...
public class Response {
    ...
    @Header
    @RepeatHeader
    private List<Status> repeatingEnumHeaderList;

    @Header
    @RepeatHeader
    private Set<Status> repeatingEnumHeaderSet;
    ...
    public List<Status> getRepeatingEnumHeaderList() {
        return repeatingEnumHeaderList;
    }

    public void setRepeatingEnumHeaderList(final List<Status> repeatingEnumHeaderList) {
        this.repeatingEnumHeaderList = repeatingEnumHeaderList;
    }

    public Set<Status> getRepeatingEnumHeaderSet() {
        return repeatingEnumHeaderSet;
    }

    public void setRepeatingEnumHeaderSet(final Set<Status> repeatingEnumHeaderSet) {
