...
final class VirtualInternalsMicroService {
    ...
    void put(@RemoteAddress String internalRemoteAddress1,
             SocketAddress internalRemoteAddress2,
             @RequestUrlPath String internalUrlPath,
             @RequestMethod String internalRequestMethod,
             HttpVersion internalHttpVersion,
             HttpHeaders internalRequestHeaders,
             @RequestBody byte[] internalRequestBody,
             HttpRequest internalRequest,
             @RequestId String internalRequestId) {
        // do something
    }
}
