...
import io.rxmicro.examples.rest.controller.extendable.model.request.path_vars_only.parent_model_without_fields.child.Child;
import io.rxmicro.rest.method.PUT;

public class MicroService {

    @PUT(value = "/1/${grandVar}/${childVar}", httpBody = false)
