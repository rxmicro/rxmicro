...
public final class $$ModelModelToJsonConverter extends ModelToJsonConverter<Model> {
    ...
    public Map<String, Object> toJsonObject(final Model model) {
        return new JsonObjectBuilder()
                ...
                .put("optionalSet", model.optionalSet)
                .put("booleanSet", model.booleanSet)
                .put("byteSet", model.byteSet)
                .put("shortSet", model.shortSet)
                .put("intSet", model.intSet)
                .put("longSet", model.longSet)
                .put("charSet", model.charSet)
                .put("floatSet", model.floatSet)
                .put("doubleSet", model.doubleSet)
                .put("decimalSet", model.decimalSet)
                .put("bigIntegerSet", model.bigIntegerSet)
                .put("stringSet", model.stringSet)
                .put("instantSet", model.instantSet)
                .put("colorSet", model.colorSet)
                .put("optionalMap", model.optionalMap)
                .put("booleanMap", model.booleanMap)
                .put("byteMap", model.byteMap)
                .put("shortMap", model.shortMap)
                .put("intMap", model.intMap)
                .put("longMap", model.longMap)
                .put("charMap", model.charMap)
                .put("floatMap", model.floatMap)
                .put("doubleMap", model.doubleMap)
                .put("decimalMap", model.decimalMap)
                .put("bigIntegerMap", model.bigIntegerMap)
                .put("stringMap", model.stringMap)
                .put("instantMap", model.instantMap)
                .put("colorMap", model.colorMap)
