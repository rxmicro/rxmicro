...
public final class $$VirtualParamsMicroService extends AbstractRestController {
    ...
    private $$VirtualVirtualParamsRequest2ConstraintValidator virtualVirtualParamsRequest2ConstraintValidator;

    private $$VirtualVirtualParamsRequestConstraintValidator virtualVirtualParamsRequestConstraintValidator;
    ...
    protected void postConstruct() {
        ...
        virtualVirtualParamsRequest2ConstraintValidator = new $$VirtualVirtualParamsRequest2ConstraintValidator();
        virtualVirtualParamsRequestConstraintValidator = new $$VirtualVirtualParamsRequestConstraintValidator();
    }
    ...
    private CompletionStage<HttpResponse> get(final PathVariableMapping pathVariableMapping,
        ...
        virtualVirtualParamsRequestConstraintValidator.validate(req);
    ...
    private CompletionStage<HttpResponse> put(final PathVariableMapping pathVariableMapping,
        ...
        virtualVirtualParamsRequest2ConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
