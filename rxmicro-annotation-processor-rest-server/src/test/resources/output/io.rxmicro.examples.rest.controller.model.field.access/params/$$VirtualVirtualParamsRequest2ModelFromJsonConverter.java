...
import io.rxmicro.examples.rest.controller.model.field.access.params.direct.nested.$$NestedModelFromJsonConverter;
 ...
 */
public final class $$VirtualVirtualParamsRequest2ModelFromJsonConverter extends ModelFromJsonConverter<$$VirtualVirtualParamsRequest2> {

    private final $$NestedModelFromJsonConverter nestedModelFromJsonConverter =
            new $$NestedModelFromJsonConverter();

    @Override
    public $$VirtualVirtualParamsRequest2 fromJsonObject(final Map<String, Object> params) {
        final $$VirtualVirtualParamsRequest2 model = new $$VirtualVirtualParamsRequest2();
        readParamsToModel(params, model);
        return model;
    }

    protected void readParamsToModel(final Map<String, Object> params,
                                     final $$VirtualVirtualParamsRequest2 model) {
