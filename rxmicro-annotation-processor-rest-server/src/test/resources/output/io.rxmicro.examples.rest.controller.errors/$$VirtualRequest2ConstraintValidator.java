 ...
 */
public final class $$VirtualRequest2ConstraintValidator implements ConstraintValidator<$$VirtualRequest2> {
    ...
    @Override
    public void validateNonNull(final $$VirtualRequest2 model,
