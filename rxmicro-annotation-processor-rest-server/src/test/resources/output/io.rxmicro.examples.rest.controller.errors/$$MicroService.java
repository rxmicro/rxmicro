...
public final class $$MicroService extends AbstractRestController {
    ...
    private $$VirtualRequest2ConstraintValidator virtualRequest2ConstraintValidator;
    ...
    protected void postConstruct() {
        ...
        virtualRequest2ConstraintValidator = new $$VirtualRequest2ConstraintValidator();
    }
    ...
    private CompletionStage<HttpResponse> updateObject2(final PathVariableMapping pathVariableMapping,
        ...
        virtualRequest2ConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
