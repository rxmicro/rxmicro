...
public final class $$MappingStrategyMicroService extends AbstractRestController {
    ...
    private $$VirtualMappingStrategyRequest3ConstraintValidator virtualMappingStrategyRequest3ConstraintValidator;

    private $$VirtualMappingStrategyRequest2ConstraintValidator virtualMappingStrategyRequest2ConstraintValidator;

    private $$VirtualMappingStrategyRequestConstraintValidator virtualMappingStrategyRequestConstraintValidator;
    ...
    protected void postConstruct() {
        ...
        virtualMappingStrategyRequest3ConstraintValidator = new $$VirtualMappingStrategyRequest3ConstraintValidator();
        virtualMappingStrategyRequest2ConstraintValidator = new $$VirtualMappingStrategyRequest2ConstraintValidator();
        virtualMappingStrategyRequestConstraintValidator = new $$VirtualMappingStrategyRequestConstraintValidator();
    }
    ...
    private CompletionStage<HttpResponse> consume1(final PathVariableMapping pathVariableMapping,
        ...
        virtualMappingStrategyRequestConstraintValidator.validate(req);
    ...
    private CompletionStage<HttpResponse> consume2(final PathVariableMapping pathVariableMapping,
        ...
        virtualMappingStrategyRequest2ConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
    ...
    private CompletionStage<HttpResponse> consume3(final PathVariableMapping pathVariableMapping,
        ...
        virtualMappingStrategyRequest3ConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
