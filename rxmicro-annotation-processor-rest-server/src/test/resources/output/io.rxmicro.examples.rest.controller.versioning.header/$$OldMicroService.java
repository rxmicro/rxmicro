 ...
 */
public final class $$OldMicroService extends AbstractRestController {

    private OldMicroService restController;

    @Override
    protected void postConstruct() {
        restController = new OldMicroService();
    }

    @Override
    public Class<?> getRestControllerClass() {
        return OldMicroService.class;
    }
