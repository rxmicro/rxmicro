 ...
 */
public final class $$VirtualWithBodyRequest5ConstraintValidator implements ConstraintValidator<$$VirtualWithBodyRequest5> {
    ...
    @Override
    public void validateNonNull(final $$VirtualWithBodyRequest5 model,
