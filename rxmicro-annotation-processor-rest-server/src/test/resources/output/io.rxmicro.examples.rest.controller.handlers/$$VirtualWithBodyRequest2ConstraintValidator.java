 ...
 */
public final class $$VirtualWithBodyRequest2ConstraintValidator implements ConstraintValidator<$$VirtualWithBodyRequest2> {
    ...
    @Override
    public void validateNonNull(final $$VirtualWithBodyRequest2 model,
