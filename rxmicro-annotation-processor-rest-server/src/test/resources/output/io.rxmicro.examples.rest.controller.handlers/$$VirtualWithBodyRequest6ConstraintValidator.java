 ...
 */
public final class $$VirtualWithBodyRequest6ConstraintValidator implements ConstraintValidator<$$VirtualWithBodyRequest6> {
    ...
    @Override
    public void validateNonNull(final $$VirtualWithBodyRequest6 model,
