 ...
 */
public final class $$VirtualWithoutBodyRequest5ConstraintValidator implements ConstraintValidator<$$VirtualWithoutBodyRequest5> {
    ...
    @Override
    public void validateNonNull(final $$VirtualWithoutBodyRequest5 model,
