 ...
 */
public final class $$VirtualWithBodyRequest7ConstraintValidator implements ConstraintValidator<$$VirtualWithBodyRequest7> {
    ...
    @Override
    public void validateNonNull(final $$VirtualWithBodyRequest7 model,
