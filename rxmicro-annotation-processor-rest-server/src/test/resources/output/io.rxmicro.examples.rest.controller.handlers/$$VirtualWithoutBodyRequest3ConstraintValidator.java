 ...
 */
public final class $$VirtualWithoutBodyRequest3ConstraintValidator implements ConstraintValidator<$$VirtualWithoutBodyRequest3> {
    ...
    @Override
    public void validateNonNull(final $$VirtualWithoutBodyRequest3 model,
