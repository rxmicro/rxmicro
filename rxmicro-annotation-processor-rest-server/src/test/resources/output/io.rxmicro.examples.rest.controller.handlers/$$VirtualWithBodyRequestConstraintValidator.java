 ...
 */
public final class $$VirtualWithBodyRequestConstraintValidator implements ConstraintValidator<$$VirtualWithBodyRequest> {
    ...
    @Override
    public void validateNonNull(final $$VirtualWithBodyRequest model,
