package rxmicro.examples.rest.controller.versioning.url.path;
...
public final class $$RestControllerAggregatorImpl extends RestControllerAggregator {
    ...
    protected List<AbstractRestController> listAllRestControllers() {
        return List.of(
                new io.rxmicro.examples.rest.controller.versioning.url.path.$$NewMicroService(),
                new io.rxmicro.examples.rest.controller.versioning.url.path.$$OldMicroService(),
