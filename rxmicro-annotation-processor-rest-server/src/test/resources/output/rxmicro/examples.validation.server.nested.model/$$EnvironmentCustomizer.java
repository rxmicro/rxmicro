package rxmicro.examples.validation.server.nested.model;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.validation.server.nested.model", RX_MICRO_REFLECTION_MODULE);
    }
