package rxmicro.examples.rest.controller.path.variables;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.rest.controller.path.variables", RX_MICRO_REFLECTION_MODULE);
    }
