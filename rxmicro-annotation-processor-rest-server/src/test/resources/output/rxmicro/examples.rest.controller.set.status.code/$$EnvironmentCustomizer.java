package rxmicro.examples.rest.controller.set.status.code;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.rest.controller.set.status.code", RX_MICRO_REFLECTION_MODULE);
    }
