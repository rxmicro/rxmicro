...
public final class $$RestControllerAggregatorImpl extends RestControllerAggregator {
    ...
    protected List<AbstractRestController> listAllRestControllers() {
        return List.of(
                new io.rxmicro.examples.validation.server.extendable.model.all_models_contain_fields.$$MicroService(),
                new io.rxmicro.examples.validation.server.extendable.model.child_model_without_fields.$$MicroService(),
                new io.rxmicro.examples.validation.server.extendable.model.grand_parent_model_without_fields.$$MicroService(),
                new io.rxmicro.examples.validation.server.extendable.model.parent_model_without_fields.$$MicroService(),
