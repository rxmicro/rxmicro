...
import io.rxmicro.examples.rest.controller.model.types.model.request.http_body.$$HttpBodyRequestConstraintValidator;
import io.rxmicro.examples.rest.controller.model.types.model.request.http_body.$$HttpBodyRequestServerModelReader;
import io.rxmicro.examples.rest.controller.model.types.model.request.http_body.$$HttpBodyWithHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.http_body.$$HttpBodyWithInternalsAndHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.http_body.$$HttpBodyWithInternalsRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.http_body.$$HttpBodyWithPathVarAndHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.http_body.$$HttpBodyWithPathVarAndInternalsAndHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.http_body.$$HttpBodyWithPathVarAndInternalsRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.http_body.$$HttpBodyWithPathVarRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_or_http_body.$$QueryOrHttpBodyRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_or_http_body.$$QueryOrHttpBodyWithHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_or_http_body.$$QueryOrHttpBodyWithInternalsAndHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_or_http_body.$$QueryOrHttpBodyWithInternalsRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_or_http_body.$$QueryOrHttpBodyWithPathVarAndHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_or_http_body.$$QueryOrHttpBodyWithPathVarAndInternalsAndHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_or_http_body.$$QueryOrHttpBodyWithPathVarAndInternalsRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_or_http_body.$$QueryOrHttpBodyWithPathVarRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_string.$$QueryStringRequestConstraintValidator;
import io.rxmicro.examples.rest.controller.model.types.model.request.query_string.$$QueryStringRequestServerModelReader;
import io.rxmicro.examples.rest.controller.model.types.model.request.query_string.$$QueryStringWithHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_string.$$QueryStringWithInternalsAndHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_string.$$QueryStringWithInternalsRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_string.$$QueryStringWithPathVarAndHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_string.$$QueryStringWithPathVarAndInternalsAndHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_string.$$QueryStringWithPathVarAndInternalsRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.query_string.$$QueryStringWithPathVarRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.without_body.$$HeadersOnlyRequestConstraintValidator;
import io.rxmicro.examples.rest.controller.model.types.model.request.without_body.$$HeadersOnlyRequestServerModelReader;
import io.rxmicro.examples.rest.controller.model.types.model.request.without_body.$$InternalsAndHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.without_body.$$PathVarAndHeadersRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.without_body.$$PathVarAndInternalsRequestConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.request.without_body.$$PathVarOnlyRequestConstraintValidator;
...
public final class $$ConsumeMicroService extends AbstractRestController {
    ...
    private $$HttpBodyWithPathVarAndHeadersRequestConstraintValidator httpBodyWithPathVarAndHeadersRequestConstraintValidator;

    private $$QueryOrHttpBodyWithInternalsRequestConstraintValidator queryOrHttpBodyWithInternalsRequestConstraintValidator;

    private $$QueryOrHttpBodyWithInternalsAndHeadersRequestConstraintValidator queryOrHttpBodyWithInternalsAndHeadersRequestConstraintValidator;

    private $$QueryOrHttpBodyWithPathVarAndHeadersRequestConstraintValidator queryOrHttpBodyWithPathVarAndHeadersRequestConstraintValidator;

    private $$QueryStringWithPathVarRequestConstraintValidator queryStringWithPathVarRequestConstraintValidator;

    private $$QueryStringWithHeadersRequestConstraintValidator queryStringWithHeadersRequestConstraintValidator;

    private $$HttpBodyWithPathVarAndInternalsAndHeadersRequestConstraintValidator httpBodyWithPathVarAndInternalsAndHeadersRequestConstraintValidator;

    private $$HttpBodyRequestConstraintValidator httpBodyRequestConstraintValidator;

    private $$HttpBodyWithInternalsAndHeadersRequestConstraintValidator httpBodyWithInternalsAndHeadersRequestConstraintValidator;

    private $$HttpBodyWithPathVarAndInternalsRequestConstraintValidator httpBodyWithPathVarAndInternalsRequestConstraintValidator;

    private $$PathVarAndInternalsRequestConstraintValidator pathVarAndInternalsRequestConstraintValidator;

    private $$QueryStringWithPathVarAndHeadersRequestConstraintValidator queryStringWithPathVarAndHeadersRequestConstraintValidator;

    private $$QueryOrHttpBodyWithPathVarAndInternalsRequestConstraintValidator queryOrHttpBodyWithPathVarAndInternalsRequestConstraintValidator;

    private $$HttpBodyWithHeadersRequestConstraintValidator httpBodyWithHeadersRequestConstraintValidator;

    private $$QueryOrHttpBodyRequestConstraintValidator queryOrHttpBodyRequestConstraintValidator;

    private $$QueryOrHttpBodyWithPathVarAndInternalsAndHeadersRequestConstraintValidator queryOrHttpBodyWithPathVarAndInternalsAndHeadersRequestConstraintValidator;

    private $$PathVarOnlyRequestConstraintValidator pathVarOnlyRequestConstraintValidator;

    private $$QueryStringWithInternalsRequestConstraintValidator queryStringWithInternalsRequestConstraintValidator;

    private $$InternalsAndHeadersRequestConstraintValidator internalsAndHeadersRequestConstraintValidator;

    private $$HttpBodyWithPathVarRequestConstraintValidator httpBodyWithPathVarRequestConstraintValidator;

    private $$QueryStringWithPathVarAndInternalsAndHeadersRequestConstraintValidator queryStringWithPathVarAndInternalsAndHeadersRequestConstraintValidator;

    private $$PathVarAndHeadersRequestConstraintValidator pathVarAndHeadersRequestConstraintValidator;

    private $$QueryStringRequestConstraintValidator queryStringRequestConstraintValidator;

    private $$QueryOrHttpBodyWithPathVarRequestConstraintValidator queryOrHttpBodyWithPathVarRequestConstraintValidator;

    private $$QueryOrHttpBodyWithHeadersRequestConstraintValidator queryOrHttpBodyWithHeadersRequestConstraintValidator;

    private $$QueryStringWithPathVarAndInternalsRequestConstraintValidator queryStringWithPathVarAndInternalsRequestConstraintValidator;

    private $$HttpBodyWithInternalsRequestConstraintValidator httpBodyWithInternalsRequestConstraintValidator;

    private $$HeadersOnlyRequestConstraintValidator headersOnlyRequestConstraintValidator;

    private $$QueryStringWithInternalsAndHeadersRequestConstraintValidator queryStringWithInternalsAndHeadersRequestConstraintValidator;
    ...
    protected void postConstruct() {
        ...
        httpBodyWithPathVarAndHeadersRequestConstraintValidator = new $$HttpBodyWithPathVarAndHeadersRequestConstraintValidator();
        queryOrHttpBodyWithInternalsRequestConstraintValidator = new $$QueryOrHttpBodyWithInternalsRequestConstraintValidator();
        queryOrHttpBodyWithInternalsAndHeadersRequestConstraintValidator = new $$QueryOrHttpBodyWithInternalsAndHeadersRequestConstraintValidator();
        queryOrHttpBodyWithPathVarAndHeadersRequestConstraintValidator = new $$QueryOrHttpBodyWithPathVarAndHeadersRequestConstraintValidator();
        queryStringWithPathVarRequestConstraintValidator = new $$QueryStringWithPathVarRequestConstraintValidator();
        queryStringWithHeadersRequestConstraintValidator = new $$QueryStringWithHeadersRequestConstraintValidator();
        httpBodyWithPathVarAndInternalsAndHeadersRequestConstraintValidator = new $$HttpBodyWithPathVarAndInternalsAndHeadersRequestConstraintValidator();
        httpBodyRequestConstraintValidator = new $$HttpBodyRequestConstraintValidator();
        httpBodyWithInternalsAndHeadersRequestConstraintValidator = new $$HttpBodyWithInternalsAndHeadersRequestConstraintValidator();
        httpBodyWithPathVarAndInternalsRequestConstraintValidator = new $$HttpBodyWithPathVarAndInternalsRequestConstraintValidator();
        pathVarAndInternalsRequestConstraintValidator = new $$PathVarAndInternalsRequestConstraintValidator();
        queryStringWithPathVarAndHeadersRequestConstraintValidator = new $$QueryStringWithPathVarAndHeadersRequestConstraintValidator();
        queryOrHttpBodyWithPathVarAndInternalsRequestConstraintValidator = new $$QueryOrHttpBodyWithPathVarAndInternalsRequestConstraintValidator();
        httpBodyWithHeadersRequestConstraintValidator = new $$HttpBodyWithHeadersRequestConstraintValidator();
        queryOrHttpBodyRequestConstraintValidator = new $$QueryOrHttpBodyRequestConstraintValidator();
        queryOrHttpBodyWithPathVarAndInternalsAndHeadersRequestConstraintValidator = new $$QueryOrHttpBodyWithPathVarAndInternalsAndHeadersRequestConstraintValidator();
        pathVarOnlyRequestConstraintValidator = new $$PathVarOnlyRequestConstraintValidator();
        queryStringWithInternalsRequestConstraintValidator = new $$QueryStringWithInternalsRequestConstraintValidator();
        internalsAndHeadersRequestConstraintValidator = new $$InternalsAndHeadersRequestConstraintValidator();
        httpBodyWithPathVarRequestConstraintValidator = new $$HttpBodyWithPathVarRequestConstraintValidator();
        queryStringWithPathVarAndInternalsAndHeadersRequestConstraintValidator = new $$QueryStringWithPathVarAndInternalsAndHeadersRequestConstraintValidator();
        pathVarAndHeadersRequestConstraintValidator = new $$PathVarAndHeadersRequestConstraintValidator();
        queryStringRequestConstraintValidator = new $$QueryStringRequestConstraintValidator();
        queryOrHttpBodyWithPathVarRequestConstraintValidator = new $$QueryOrHttpBodyWithPathVarRequestConstraintValidator();
        queryOrHttpBodyWithHeadersRequestConstraintValidator = new $$QueryOrHttpBodyWithHeadersRequestConstraintValidator();
        queryStringWithPathVarAndInternalsRequestConstraintValidator = new $$QueryStringWithPathVarAndInternalsRequestConstraintValidator();
        httpBodyWithInternalsRequestConstraintValidator = new $$HttpBodyWithInternalsRequestConstraintValidator();
        headersOnlyRequestConstraintValidator = new $$HeadersOnlyRequestConstraintValidator();
        queryStringWithInternalsAndHeadersRequestConstraintValidator = new $$QueryStringWithInternalsAndHeadersRequestConstraintValidator();
    }
    ...
    private CompletionStage<HttpResponse> consumeHttpBodyRequest(final PathVariableMapping pathVariableMapping,
        ...
        httpBodyRequestConstraintValidator.validate(req);
    ...
    private CompletionStage<HttpResponse> consumeHttpBodyWithHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        httpBodyWithHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeHttpBodyWithPathVarRequest(final PathVariableMapping pathVariableMapping,
        ...
        httpBodyWithPathVarRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeHttpBodyWithInternalsRequest(final PathVariableMapping pathVariableMapping,
        ...
        httpBodyWithInternalsRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeHttpBodyWithInternalsAndHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        httpBodyWithInternalsAndHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeHttpBodyWithPathVarAndHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        httpBodyWithPathVarAndHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeHttpBodyWithPathVarAndInternalsRequest(final PathVariableMapping pathVariableMapping,
        ...
        httpBodyWithPathVarAndInternalsRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeHttpBodyWithPathVarAndInternalsAndHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        httpBodyWithPathVarAndInternalsAndHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumePathVarOnlyRequest(final PathVariableMapping pathVariableMapping,
        ...
        pathVarOnlyRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeHeadersOnlyRequest(final PathVariableMapping pathVariableMapping,
        ...
        headersOnlyRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeInternalsAndHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        internalsAndHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumePathVarAndInternalsRequest(final PathVariableMapping pathVariableMapping,
        ...
        pathVarAndInternalsRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumePathVarAndHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        pathVarAndHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryOrHttpBodyRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryOrHttpBodyRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryOrHttpBodyWithHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryOrHttpBodyWithHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryOrHttpBodyWithPathVarRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryOrHttpBodyWithPathVarRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryOrHttpBodyWithInternalsRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryOrHttpBodyWithInternalsRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryOrHttpBodyWithInternalsAndHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryOrHttpBodyWithInternalsAndHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryOrHttpBodyWithPathVarAndHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryOrHttpBodyWithPathVarAndHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryOrHttpBodyWithPathVarAndInternalsRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryOrHttpBodyWithPathVarAndInternalsRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryOrHttpBodyWithPathVarAndInternalsAndHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryOrHttpBodyWithPathVarAndInternalsAndHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryStringRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryStringRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryStringWithHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryStringWithHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryStringWithPathVarRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryStringWithPathVarRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryStringWithInternalsRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryStringWithInternalsRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryStringWithInternalsAndHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryStringWithInternalsAndHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryStringWithPathVarAndHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryStringWithPathVarAndHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryStringWithPathVarAndInternalsRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryStringWithPathVarAndInternalsRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
    ...
    private CompletionStage<HttpResponse> consumeQueryStringWithPathVarAndInternalsAndHeadersRequest(final PathVariableMapping pathVariableMapping,
        ...
        queryStringWithPathVarAndInternalsAndHeadersRequestConstraintValidator.validate(req);
        final HttpHeaders headers = HttpHeaders.of();
        restController.consume(req);
        return CompletableFuture.completedStage(buildResponse(200, headers));
    }
