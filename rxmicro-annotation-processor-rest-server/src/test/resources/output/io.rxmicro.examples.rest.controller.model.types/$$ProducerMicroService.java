...
import io.rxmicro.examples.rest.controller.model.types.model.response.body.$$BodyOnlyResponseConstraintValidator;
import io.rxmicro.examples.rest.controller.model.types.model.response.body.$$BodyOnlyResponseServerModelWriter;
import io.rxmicro.examples.rest.controller.model.types.model.response.body.$$BodyWithHeadersResponseConstraintValidator;
import io.rxmicro.examples.rest.controller.model.types.model.response.body.$$BodyWithHeadersResponseServerModelWriter;
import io.rxmicro.examples.rest.controller.model.types.model.response.body.$$BodyWithInternalsAndHeadersResponseConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.response.body.$$BodyWithInternalsResponseConstraintValidator;
...
import io.rxmicro.examples.rest.controller.model.types.model.response.without_body.$$HeadersOnlyResponseConstraintValidator;
import io.rxmicro.examples.rest.controller.model.types.model.response.without_body.$$HeadersOnlyResponseServerModelWriter;
import io.rxmicro.examples.rest.controller.model.types.model.response.without_body.$$InternalsAndHeadersResponseConstraintValidator;
...
public final class $$ProducerMicroService extends AbstractRestController {
    ...
    private $$BodyWithInternalsAndHeadersResponseConstraintValidator bodyWithInternalsAndHeadersResponseConstraintValidator;

    private $$BodyOnlyResponseConstraintValidator bodyOnlyResponseConstraintValidator;

    private $$BodyWithHeadersResponseConstraintValidator bodyWithHeadersResponseConstraintValidator;

    private $$HeadersOnlyResponseConstraintValidator headersOnlyResponseConstraintValidator;

    private $$BodyWithInternalsResponseConstraintValidator bodyWithInternalsResponseConstraintValidator;

    private $$InternalsAndHeadersResponseConstraintValidator internalsAndHeadersResponseConstraintValidator;
    ...
    protected void postConstruct() {
        ...
        bodyWithInternalsAndHeadersResponseConstraintValidator = new $$BodyWithInternalsAndHeadersResponseConstraintValidator();
        bodyOnlyResponseConstraintValidator = new $$BodyOnlyResponseConstraintValidator();
        bodyWithHeadersResponseConstraintValidator = new $$BodyWithHeadersResponseConstraintValidator();
        headersOnlyResponseConstraintValidator = new $$HeadersOnlyResponseConstraintValidator();
        bodyWithInternalsResponseConstraintValidator = new $$BodyWithInternalsResponseConstraintValidator();
        internalsAndHeadersResponseConstraintValidator = new $$InternalsAndHeadersResponseConstraintValidator();
    }
    ...
    private HttpResponse buildResponse(final BodyWithInternalsAndHeadersResponse model,
        ...
        validateResponse(restServerConfig.isEnableAdditionalValidations(), bodyWithInternalsAndHeadersResponseConstraintValidator, model);
    ...
    private HttpResponse buildResponse(final BodyOnlyResponse model,
                                       final int statusCode,
                                       final HttpHeaders headers) {
        validateResponse(restServerConfig.isEnableAdditionalValidations(), bodyOnlyResponseConstraintValidator, model);
        final HttpResponse response = httpResponseBuilder.build();
        response.setStatus(statusCode);
        response.setOrAddHeaders(headers);
    ...
    private HttpResponse buildResponse(final BodyWithHeadersResponse model,
                                       final int statusCode,
                                       final HttpHeaders headers) {
        validateResponse(restServerConfig.isEnableAdditionalValidations(), bodyWithHeadersResponseConstraintValidator, model);
        final HttpResponse response = httpResponseBuilder.build();
        response.setStatus(statusCode);
        response.setOrAddHeaders(headers);
    ...
    private HttpResponse buildResponse(final HeadersOnlyResponse model,
                                       final int statusCode,
                                       final HttpHeaders headers) {
        validateResponse(restServerConfig.isEnableAdditionalValidations(), headersOnlyResponseConstraintValidator, model);
        final HttpResponse response = httpResponseBuilder.build();
        response.setStatus(statusCode);
        response.setOrAddHeaders(headers);
    ...
    private HttpResponse buildResponse(final BodyWithInternalsResponse model,
                                       final int statusCode,
                                       final HttpHeaders headers) {
        validateResponse(restServerConfig.isEnableAdditionalValidations(), bodyWithInternalsResponseConstraintValidator, model);
        final HttpResponse response = httpResponseBuilder.build();
        response.setStatus(statusCode);
        response.setOrAddHeaders(headers);
    ...
    private HttpResponse buildResponse(final InternalsAndHeadersResponse model,
                                       final int statusCode,
                                       final HttpHeaders headers) {
        validateResponse(restServerConfig.isEnableAdditionalValidations(), internalsAndHeadersResponseConstraintValidator, model);
        final HttpResponse response = httpResponseBuilder.build();
        response.setStatus(statusCode);
        response.setOrAddHeaders(headers);
