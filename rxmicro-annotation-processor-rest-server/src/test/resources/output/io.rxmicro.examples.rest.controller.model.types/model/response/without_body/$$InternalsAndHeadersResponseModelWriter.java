 ...
 */
public final class $$InternalsAndHeadersResponseModelWriter extends ModelWriter<InternalsAndHeadersResponse> {

    public $$InternalsAndHeadersResponseModelWriter(final boolean humanReadableOutput) {
        //do nothing
    }
    ...
    protected void writePrimitivesToResponse(final InternalsAndHeadersResponse model,
                                             final HttpResponse response) {
