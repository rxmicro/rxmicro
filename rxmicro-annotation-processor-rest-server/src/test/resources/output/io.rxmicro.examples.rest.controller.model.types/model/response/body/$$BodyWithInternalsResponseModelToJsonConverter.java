 ...
 */
public final class $$BodyWithInternalsResponseModelToJsonConverter extends ModelToJsonConverter<BodyWithInternalsResponse> {

    private final $$NestedModelToJsonConverter nestedModelToJsonConverter =
            new $$NestedModelToJsonConverter();

    @Override
    public Map<String, Object> toJsonObject(final BodyWithInternalsResponse model) {
        final JsonObjectBuilder builder = new JsonObjectBuilder();
        putValuesToBuilder(model, builder);
        return builder.build();
    }

    protected void putValuesToBuilder(final BodyWithInternalsResponse model,
