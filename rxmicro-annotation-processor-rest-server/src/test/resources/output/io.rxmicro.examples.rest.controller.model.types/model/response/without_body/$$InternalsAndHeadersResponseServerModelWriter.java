 ...
 */
public final class $$InternalsAndHeadersResponseServerModelWriter extends ServerModelWriter<InternalsAndHeadersResponse> {

    public $$InternalsAndHeadersResponseServerModelWriter(final boolean humanReadableOutput) {
        //do nothing
    }

    @Override
    public void write(final InternalsAndHeadersResponse model,
                      final HttpResponse response) {
        writePrimitivesToResponse(model, response);
    }

    public void writePrimitivesToResponse(final InternalsAndHeadersResponse model,
                                          final HttpResponse response) {
