 ...
 */
public final class $$BodyWithInternalsAndHeadersResponseServerModelWriter extends ServerModelWriter<BodyWithInternalsAndHeadersResponse> {

    private final $$BodyWithInternalsAndHeadersResponseModelToJsonConverter bodyWithInternalsAndHeadersResponseModelToJsonConverter;

    private final ExchangeDataFormatConverter<Object> exchangeDataFormatConverter;

    private final String outputMimeType;

    public $$BodyWithInternalsAndHeadersResponseServerModelWriter(final boolean humanReadableOutput) {
        exchangeDataFormatConverter = new JsonExchangeDataFormatConverter(humanReadableOutput);
        bodyWithInternalsAndHeadersResponseModelToJsonConverter = new $$BodyWithInternalsAndHeadersResponseModelToJsonConverter();
        outputMimeType = exchangeDataFormatConverter.getMimeType();
    }

    @Override
    public void write(final BodyWithInternalsAndHeadersResponse model,
                      final HttpResponse response) {
        writePrimitivesToResponse(model, response);
        response.setHeader(HttpStandardHeaderNames.CONTENT_TYPE, outputMimeType);
        final Map<String, Object> json = bodyWithInternalsAndHeadersResponseModelToJsonConverter.toJsonObject(model);
