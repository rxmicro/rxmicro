 ...
 */
public final class $$HeadersOnlyResponseModelWriter extends ModelWriter<HeadersOnlyResponse> {

    public $$HeadersOnlyResponseModelWriter(final boolean humanReadableOutput) {
        //do nothing
    }
    ...
    protected void writePrimitivesToResponse(final HeadersOnlyResponse model,
                                             final HttpResponse response) {
