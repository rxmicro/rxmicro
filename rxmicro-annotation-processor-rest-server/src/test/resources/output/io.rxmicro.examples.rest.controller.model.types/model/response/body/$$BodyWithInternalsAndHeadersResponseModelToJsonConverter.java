 ...
 */
public final class $$BodyWithInternalsAndHeadersResponseModelToJsonConverter extends ModelToJsonConverter<BodyWithInternalsAndHeadersResponse> {

    private final $$NestedModelToJsonConverter nestedModelToJsonConverter =
            new $$NestedModelToJsonConverter();

    @Override
    public Map<String, Object> toJsonObject(final BodyWithInternalsAndHeadersResponse model) {
