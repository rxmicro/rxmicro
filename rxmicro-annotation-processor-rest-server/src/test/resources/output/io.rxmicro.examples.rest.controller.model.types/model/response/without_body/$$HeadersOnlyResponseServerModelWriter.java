 ...
 */
public final class $$HeadersOnlyResponseServerModelWriter extends ServerModelWriter<HeadersOnlyResponse> {

    public $$HeadersOnlyResponseServerModelWriter(final boolean humanReadableOutput) {
        //do nothing
    }

    @Override
    public void write(final HeadersOnlyResponse model,
                      final HttpResponse response) {
        writePrimitivesToResponse(model, response);
    }

    public void writePrimitivesToResponse(final HeadersOnlyResponse model,
                                          final HttpResponse response) {
