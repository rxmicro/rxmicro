 ...
 */
public final class $$HttpBodyWithHeadersRequestModelFromJsonConverter extends ModelFromJsonConverter<HttpBodyWithHeadersRequest> {

    private final $$NestedModelFromJsonConverter nestedModelFromJsonConverter =
            new $$NestedModelFromJsonConverter();

    @Override
    public HttpBodyWithHeadersRequest fromJsonObject(final Map<String, Object> params) {
        final HttpBodyWithHeadersRequest model = new HttpBodyWithHeadersRequest();
