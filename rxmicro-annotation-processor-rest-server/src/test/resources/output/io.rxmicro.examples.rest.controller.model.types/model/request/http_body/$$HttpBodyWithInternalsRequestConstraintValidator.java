 ...
 */
public final class $$HttpBodyWithInternalsRequestConstraintValidator implements ConstraintValidator<HttpBodyWithInternalsRequest> {
    ...
    @Override
    public void validateNonNull(final HttpBodyWithInternalsRequest model,
