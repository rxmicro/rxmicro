 ...
 */
public final class $$QueryOrHttpBodyWithPathVarAndInternalsAndHeadersRequestServerModelReader extends ServerModelReader<QueryOrHttpBodyWithPathVarAndInternalsAndHeadersRequest> {

    private final ExchangeDataFormatConverter<Object> exchangeDataFormatConverter =
            new JsonExchangeDataFormatConverter(false);

    private final $$QueryOrHttpBodyWithPathVarAndInternalsAndHeadersRequestModelFromJsonConverter queryOrHttpBodyWithPathVarAndInternalsAndHeadersRequestModelFromJsonConverter =
            new $$QueryOrHttpBodyWithPathVarAndInternalsAndHeadersRequestModelFromJsonConverter();

    @Override
    public QueryOrHttpBodyWithPathVarAndInternalsAndHeadersRequest read(final PathVariableMapping pathVariableMapping,
                                                                        final HttpRequest request,
                                                                        final boolean readParametersFromBody) {
        if (readParametersFromBody) {
            final Object body = exchangeDataFormatConverter.fromBytes(request.getContent());
            final QueryOrHttpBodyWithPathVarAndInternalsAndHeadersRequest model = queryOrHttpBodyWithPathVarAndInternalsAndHeadersRequestModelFromJsonConverter.fromJsonObject(body);
            readPrimitivesToModel(pathVariableMapping, request, QueryParams.of(), model, readParametersFromBody);
            return model;
        } else {
            final QueryOrHttpBodyWithPathVarAndInternalsAndHeadersRequest model = new QueryOrHttpBodyWithPathVarAndInternalsAndHeadersRequest();
    ...
    public void readPrimitivesToModel(final PathVariableMapping pathVariableMapping,
                                      ...
                                      final QueryOrHttpBodyWithPathVarAndInternalsAndHeadersRequest model,
                                      final boolean readParametersFromBody) {
