 ...
 */
public final class $$HttpBodyWithInternalsAndHeadersRequestModelFromJsonConverter extends ModelFromJsonConverter<HttpBodyWithInternalsAndHeadersRequest> {

    private final $$NestedModelFromJsonConverter nestedModelFromJsonConverter =
            new $$NestedModelFromJsonConverter();

    @Override
    public HttpBodyWithInternalsAndHeadersRequest fromJsonObject(final Map<String, Object> params) {
        final HttpBodyWithInternalsAndHeadersRequest model = new HttpBodyWithInternalsAndHeadersRequest();
