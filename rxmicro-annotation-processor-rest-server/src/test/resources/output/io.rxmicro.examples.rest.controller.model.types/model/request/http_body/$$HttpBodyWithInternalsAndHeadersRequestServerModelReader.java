 ...
 */
public final class $$HttpBodyWithInternalsAndHeadersRequestServerModelReader extends ServerModelReader<HttpBodyWithInternalsAndHeadersRequest> {

    private final ExchangeDataFormatConverter<Object> exchangeDataFormatConverter =
            new JsonExchangeDataFormatConverter(false);

    private final $$HttpBodyWithInternalsAndHeadersRequestModelFromJsonConverter httpBodyWithInternalsAndHeadersRequestModelFromJsonConverter =
            new $$HttpBodyWithInternalsAndHeadersRequestModelFromJsonConverter();

    @Override
    public HttpBodyWithInternalsAndHeadersRequest read(final PathVariableMapping pathVariableMapping,
                                                       final HttpRequest request,
                                                       final boolean readParametersFromBody) {
        final Object body = exchangeDataFormatConverter.fromBytes(request.getContent());
        final HttpBodyWithInternalsAndHeadersRequest model = httpBodyWithInternalsAndHeadersRequestModelFromJsonConverter.fromJsonObject(body);
    ...
    public void readPrimitivesToModel(final PathVariableMapping pathVariableMapping,
                                      ...
                                      final HttpBodyWithInternalsAndHeadersRequest model,
                                      final boolean readParametersFromBody) {
