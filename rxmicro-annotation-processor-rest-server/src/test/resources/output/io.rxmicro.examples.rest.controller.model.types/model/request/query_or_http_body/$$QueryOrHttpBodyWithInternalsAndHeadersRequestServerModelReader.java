 ...
 */
public final class $$QueryOrHttpBodyWithInternalsAndHeadersRequestServerModelReader extends ServerModelReader<QueryOrHttpBodyWithInternalsAndHeadersRequest> {

    private final ExchangeDataFormatConverter<Object> exchangeDataFormatConverter =
            new JsonExchangeDataFormatConverter(false);

    private final $$QueryOrHttpBodyWithInternalsAndHeadersRequestModelFromJsonConverter queryOrHttpBodyWithInternalsAndHeadersRequestModelFromJsonConverter =
            new $$QueryOrHttpBodyWithInternalsAndHeadersRequestModelFromJsonConverter();

    @Override
    public QueryOrHttpBodyWithInternalsAndHeadersRequest read(final PathVariableMapping pathVariableMapping,
                                                              final HttpRequest request,
                                                              final boolean readParametersFromBody) {
        if (readParametersFromBody) {
            final Object body = exchangeDataFormatConverter.fromBytes(request.getContent());
            final QueryOrHttpBodyWithInternalsAndHeadersRequest model = queryOrHttpBodyWithInternalsAndHeadersRequestModelFromJsonConverter.fromJsonObject(body);
            readPrimitivesToModel(pathVariableMapping, request, QueryParams.of(), model, readParametersFromBody);
            return model;
        } else {
            final QueryOrHttpBodyWithInternalsAndHeadersRequest model = new QueryOrHttpBodyWithInternalsAndHeadersRequest();
