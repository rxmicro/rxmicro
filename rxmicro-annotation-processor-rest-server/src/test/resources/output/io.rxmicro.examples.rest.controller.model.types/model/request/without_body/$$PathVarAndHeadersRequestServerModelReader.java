 ...
 */
public final class $$PathVarAndHeadersRequestServerModelReader extends ServerModelReader<PathVarAndHeadersRequest> {

    @Override
    public PathVarAndHeadersRequest read(final PathVariableMapping pathVariableMapping,
                                         final HttpRequest request,
                                         final boolean readParametersFromBody) {
        final PathVarAndHeadersRequest model = new PathVarAndHeadersRequest();
