 ...
 */
public final class $$QueryStringWithPathVarAndHeadersRequestServerModelReader extends ServerModelReader<QueryStringWithPathVarAndHeadersRequest> {

    @Override
    public QueryStringWithPathVarAndHeadersRequest read(final PathVariableMapping pathVariableMapping,
                                                        final HttpRequest request,
                                                        final boolean readParametersFromBody) {
        final QueryStringWithPathVarAndHeadersRequest model = new QueryStringWithPathVarAndHeadersRequest();
