 ...
 */
public final class $$InternalsAndHeadersRequestConstraintValidator implements ConstraintValidator<InternalsAndHeadersRequest> {
    ...
    @Override
    public void validateNonNull(final InternalsAndHeadersRequest model,
