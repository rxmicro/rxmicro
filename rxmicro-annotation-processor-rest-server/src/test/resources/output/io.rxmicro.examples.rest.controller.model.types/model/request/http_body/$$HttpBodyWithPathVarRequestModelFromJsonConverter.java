 ...
 */
public final class $$HttpBodyWithPathVarRequestModelFromJsonConverter extends ModelFromJsonConverter<HttpBodyWithPathVarRequest> {

    private final $$NestedModelFromJsonConverter nestedModelFromJsonConverter =
            new $$NestedModelFromJsonConverter();

    @Override
    public HttpBodyWithPathVarRequest fromJsonObject(final Map<String, Object> params) {
        final HttpBodyWithPathVarRequest model = new HttpBodyWithPathVarRequest();
