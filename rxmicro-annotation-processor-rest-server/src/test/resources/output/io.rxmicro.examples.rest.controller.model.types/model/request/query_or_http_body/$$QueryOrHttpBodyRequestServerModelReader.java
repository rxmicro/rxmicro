 ...
 */
public final class $$QueryOrHttpBodyRequestServerModelReader extends ServerModelReader<QueryOrHttpBodyRequest> {

    private final ExchangeDataFormatConverter<Object> exchangeDataFormatConverter =
            new JsonExchangeDataFormatConverter(false);

    private final $$QueryOrHttpBodyRequestModelFromJsonConverter queryOrHttpBodyRequestModelFromJsonConverter =
            new $$QueryOrHttpBodyRequestModelFromJsonConverter();

    @Override
    public QueryOrHttpBodyRequest read(final PathVariableMapping pathVariableMapping,
                                       final HttpRequest request,
                                       final boolean readParametersFromBody) {
        if (readParametersFromBody) {
            final Object body = exchangeDataFormatConverter.fromBytes(request.getContent());
            final QueryOrHttpBodyRequest model = queryOrHttpBodyRequestModelFromJsonConverter.fromJsonObject(body);
            return model;
        } else {
