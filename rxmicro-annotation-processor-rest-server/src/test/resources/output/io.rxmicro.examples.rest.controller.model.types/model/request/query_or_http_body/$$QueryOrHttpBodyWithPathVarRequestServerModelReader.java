 ...
 */
public final class $$QueryOrHttpBodyWithPathVarRequestServerModelReader extends ServerModelReader<QueryOrHttpBodyWithPathVarRequest> {

    private final ExchangeDataFormatConverter<Object> exchangeDataFormatConverter =
            new JsonExchangeDataFormatConverter(false);

    private final $$QueryOrHttpBodyWithPathVarRequestModelFromJsonConverter queryOrHttpBodyWithPathVarRequestModelFromJsonConverter =
            new $$QueryOrHttpBodyWithPathVarRequestModelFromJsonConverter();

    @Override
    public QueryOrHttpBodyWithPathVarRequest read(final PathVariableMapping pathVariableMapping,
                                                  final HttpRequest request,
                                                  final boolean readParametersFromBody) {
        if (readParametersFromBody) {
            final Object body = exchangeDataFormatConverter.fromBytes(request.getContent());
            final QueryOrHttpBodyWithPathVarRequest model = queryOrHttpBodyWithPathVarRequestModelFromJsonConverter.fromJsonObject(body);
            readPrimitivesToModel(pathVariableMapping, request, QueryParams.of(), model, readParametersFromBody);
            return model;
        } else {
            final QueryOrHttpBodyWithPathVarRequest model = new QueryOrHttpBodyWithPathVarRequest();
    ...
    public void readPrimitivesToModel(final PathVariableMapping pathVariableMapping,
                                      ...
                                      final QueryOrHttpBodyWithPathVarRequest model,
                                      final boolean readParametersFromBody) {
