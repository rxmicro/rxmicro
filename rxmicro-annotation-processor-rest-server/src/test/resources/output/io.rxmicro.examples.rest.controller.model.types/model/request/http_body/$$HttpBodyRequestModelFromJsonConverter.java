 ...
 */
public final class $$HttpBodyRequestModelFromJsonConverter extends ModelFromJsonConverter<HttpBodyRequest> {

    private final $$NestedModelFromJsonConverter nestedModelFromJsonConverter =
            new $$NestedModelFromJsonConverter();

    @Override
    public HttpBodyRequest fromJsonObject(final Map<String, Object> params) {
        final HttpBodyRequest model = new HttpBodyRequest();
        readParamsToModel(params, model);
        return model;
    }

    protected void readParamsToModel(final Map<String, Object> params,
                                     final HttpBodyRequest model) {
