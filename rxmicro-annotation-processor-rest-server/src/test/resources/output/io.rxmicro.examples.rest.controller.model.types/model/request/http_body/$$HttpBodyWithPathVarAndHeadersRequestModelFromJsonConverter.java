 ...
 */
public final class $$HttpBodyWithPathVarAndHeadersRequestModelFromJsonConverter extends ModelFromJsonConverter<HttpBodyWithPathVarAndHeadersRequest> {

    private final $$NestedModelFromJsonConverter nestedModelFromJsonConverter =
            new $$NestedModelFromJsonConverter();

    @Override
    public HttpBodyWithPathVarAndHeadersRequest fromJsonObject(final Map<String, Object> params) {
        final HttpBodyWithPathVarAndHeadersRequest model = new HttpBodyWithPathVarAndHeadersRequest();
