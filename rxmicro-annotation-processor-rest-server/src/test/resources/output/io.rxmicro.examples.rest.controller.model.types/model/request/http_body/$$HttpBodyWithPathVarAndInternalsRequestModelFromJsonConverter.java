 ...
 */
public final class $$HttpBodyWithPathVarAndInternalsRequestModelFromJsonConverter extends ModelFromJsonConverter<HttpBodyWithPathVarAndInternalsRequest> {

    private final $$NestedModelFromJsonConverter nestedModelFromJsonConverter =
            new $$NestedModelFromJsonConverter();

    @Override
    public HttpBodyWithPathVarAndInternalsRequest fromJsonObject(final Map<String, Object> params) {
        final HttpBodyWithPathVarAndInternalsRequest model = new HttpBodyWithPathVarAndInternalsRequest();
