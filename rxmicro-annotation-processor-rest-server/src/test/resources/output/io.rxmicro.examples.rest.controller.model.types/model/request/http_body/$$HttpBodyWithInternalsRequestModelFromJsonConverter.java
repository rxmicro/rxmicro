 ...
 */
public final class $$HttpBodyWithInternalsRequestModelFromJsonConverter extends ModelFromJsonConverter<HttpBodyWithInternalsRequest> {

    private final $$NestedModelFromJsonConverter nestedModelFromJsonConverter =
            new $$NestedModelFromJsonConverter();

    @Override
    public HttpBodyWithInternalsRequest fromJsonObject(final Map<String, Object> params) {
        final HttpBodyWithInternalsRequest model = new HttpBodyWithInternalsRequest();
