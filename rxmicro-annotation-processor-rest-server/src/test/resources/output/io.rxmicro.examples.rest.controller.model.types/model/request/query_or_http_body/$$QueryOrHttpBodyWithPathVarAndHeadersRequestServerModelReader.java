 ...
 */
public final class $$QueryOrHttpBodyWithPathVarAndHeadersRequestServerModelReader extends ServerModelReader<QueryOrHttpBodyWithPathVarAndHeadersRequest> {

    private final ExchangeDataFormatConverter<Object> exchangeDataFormatConverter =
            new JsonExchangeDataFormatConverter(false);

    private final $$QueryOrHttpBodyWithPathVarAndHeadersRequestModelFromJsonConverter queryOrHttpBodyWithPathVarAndHeadersRequestModelFromJsonConverter =
            new $$QueryOrHttpBodyWithPathVarAndHeadersRequestModelFromJsonConverter();

    @Override
    public QueryOrHttpBodyWithPathVarAndHeadersRequest read(final PathVariableMapping pathVariableMapping,
                                                            final HttpRequest request,
                                                            final boolean readParametersFromBody) {
        if (readParametersFromBody) {
            final Object body = exchangeDataFormatConverter.fromBytes(request.getContent());
            final QueryOrHttpBodyWithPathVarAndHeadersRequest model = queryOrHttpBodyWithPathVarAndHeadersRequestModelFromJsonConverter.fromJsonObject(body);
