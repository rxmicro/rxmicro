 ...
 * @since 0.1
 */
public interface CrossOriginResourceSharingResourceBuilder {

    Set<CrossOriginResourceSharingResource> build(Collection<RestControllerClassStructure> classStructures,
                                                  RestGenerationContext context);
}
