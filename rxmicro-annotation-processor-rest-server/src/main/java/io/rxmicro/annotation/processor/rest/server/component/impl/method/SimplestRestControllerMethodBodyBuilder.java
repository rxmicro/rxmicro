 ...
 */
@Singleton
public final class SimplestRestControllerMethodBodyBuilder implements RestControllerMethodBodyBuilder {
    ...
    public MethodBody build(final RestServerModuleGeneratorConfig restServerModuleGeneratorConfig,
        ...
        return new RestControllerMethodBody(
                methodBodyGenerator.generate(
                        "rest/server/method/$$RestControllerSimplestMethodBodyTemplate.javaftl",
                        Map.of(
