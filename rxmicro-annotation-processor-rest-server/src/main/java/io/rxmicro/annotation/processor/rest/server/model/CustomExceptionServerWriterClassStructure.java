 ...
 * @since 0.1
 */
public final class CustomExceptionServerWriterClassStructure extends ClassStructure {

    private final RestObjectModelClass modelClass;

    private final boolean withValidator;

    public CustomExceptionServerWriterClassStructure(final RestObjectModelClass modelClass,
    ...
    public String getTargetFullClassName() {
        return getModelTransformerFullClassName(
                ...
                CustomExceptionServerModelWriter.class
        );
    }

    @Override
    public String getTemplateName() {
        return "rest/server/$$RestCustomExceptionServerModelWriterTemplate.javaftl";
    }
    ...
    public Map<String, Object> getTemplateVariables() {
        ...
        map.put("PARENT_CLASS", CustomExceptionServerModelWriter.class.getSimpleName());
    ...
    public ClassHeader getClassHeader() {
        final ClassHeader.Builder builder = newClassHeaderBuilder(modelClass.getModelTypeElement())
                ...
                .addImports(CustomExceptionServerModelWriter.class)
