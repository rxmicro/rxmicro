 ...
 * @since 0.1
 */
public interface RestControllerClassStructureBuilder {

    Set<RestControllerClassStructure> build(EnvironmentContext environmentContext,
                                            RestControllerClassStructureStorage restControllerClassStructureStorage,
                                            Set<RestControllerClassSignature> classSignatures);
}
