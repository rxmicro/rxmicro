 ...
 * @since 0.7
 */
public final class PlatformDependentLineSeparatorBiConsumer extends AbstractBiConsumer {

    public PlatformDependentLineSeparatorBiConsumer(final BiConsumerArguments arguments) {
        super(arguments);
