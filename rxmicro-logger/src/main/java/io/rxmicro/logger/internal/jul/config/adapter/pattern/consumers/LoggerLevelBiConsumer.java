...
import static io.rxmicro.logger.internal.jul.config.adapter.ReverseLevelMappings.getRxMicroLevel;

/**
 * @author nedis
 * @since 0.7
 */
public final class LoggerLevelBiConsumer extends AbstractBiConsumer {

    public LoggerLevelBiConsumer(final BiConsumerArguments arguments) {
        super(arguments);
