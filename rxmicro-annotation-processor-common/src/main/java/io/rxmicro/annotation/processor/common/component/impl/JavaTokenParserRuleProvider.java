...
public final class JavaTokenParserRuleProvider implements TokenParserRuleProvider {
    ...
    public TokenParserRule get() {
        if (rule == null) {
            rule = new TokenParserRule.Builder()
                    .setLineCommentStartedTokens(Set.of("//"))
                    .setMultiLineCommentStartedTokens(Set.of("/*"))
                    .setMultiLineCommentFinishedTokens(Set.of("*/"))
                    .setOperatorTokenDelimiters(Set.of(
                            "+", "++", "+=", "-", "--", "-=", "*", "*=", "/", "/=", "%", "%=",
                            ">", ">>", ">=", ">>>", ">>=", ">>>=", "<", "<<", "<=", "<<=",
                            "!", "!=", "=", "==", "&", "&&", "&=", "|", "||", "|=", "^", "^=", "~"
                    ))
                    .setNotOperatorTokenDelimiters(Set.of(
                            "(", ")",
                            "{", "}",
                            "[", "]",
                            ":",
