 ...
 * @since 0.1
 */
public interface RestModelToJsonConverterBuilder {

    Set<ModelToJsonConverterClassStructure> buildToJson(List<MappedRestObjectModelClass> mappedRestObjectModelClasses,
