...
public interface RestGenerationContextBuilder {
    ...
    RestGenerationContext build(EnvironmentContext environmentContext,
                                Class<? extends RestModuleGeneratorConfig> restModuleGeneratorConfigClass,
                                Set<? extends RestClassSignature> restClassSignatures);
}
