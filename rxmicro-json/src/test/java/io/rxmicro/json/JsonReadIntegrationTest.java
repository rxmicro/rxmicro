...
import static io.rxmicro.json.JsonDataHelper.COMPLEX_READABLE_JSON_ARRAY;
import static io.rxmicro.json.JsonDataHelper.COMPLEX_READABLE_JSON_OBJECT;
import static io.rxmicro.json.JsonDataHelper.EMPTY_JSON_ARRAY;
import static io.rxmicro.json.JsonDataHelper.EMPTY_JSON_OBJECT;
import static io.rxmicro.json.JsonDataHelper.getJsonStringFromClasspathResource;
...
final class JsonReadIntegrationTest {
    ...
    @Order(13)
    void method_readJson_should_throw_JsonException(final String json,
    ...
    @Order(14)
    void method_readJsonObject_should_throw_JsonException(final String json,
                                                          final String expectedMessage) {
    ...
    @Order(15)
    void method_readJsonArray_should_throw_JsonException(final String json,
                                                         final String expectedMessage) {
    ...
    @Order(16)
    void method_readJsonPrimitive_should_throw_JsonException(final String json,
                                                             final String expectedMessage) {
    ...
    @Order(16)
    void method_readJson_should_throw_JsonException_with_increase_recursionDepth_recommendation(final String json) {
    ...
    @Order(17)
    void method_readJson_should_throw_JsonException_if_detected_invalid_unicode_character(final String resourceName,
    ...
    @Test
    @Order(18)
    void method_readJson_should_ignore_all_delimiters() {
    ...
    @Order(19)
    void method_readJson_should_parse_unicode_characters(final String json) {
    ...
    @Order(20)
    void method_readJson_should_not_support_comments(final String json) {
