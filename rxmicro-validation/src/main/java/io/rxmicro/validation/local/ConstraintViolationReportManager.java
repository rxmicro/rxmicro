 ...
 * @since 0.12
 */
public final class ConstraintViolationReportManager {
    ...
    public static void setCurrentConstraintViolationReporter(final ConstraintViolationReporter currentConstraintViolationReporter) {
        ConstraintViolationReportManager.currentConstraintViolationReporter = require(currentConstraintViolationReporter);
    }
    ...
    private ConstraintViolationReportManager() {
    }
