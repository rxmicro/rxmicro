...
public class SizeSetConstraintValidator extends AbstractContainerConstraintValidator<Set<?>> {
    ...
    /**
     * Creates the default instance of {@link SizeSetConstraintValidator} with the specified collection size.
     *
     * @param expectedSize the specified collection size
     */
    public SizeSetConstraintValidator(final int expectedSize) {
