...
import io.rxmicro.validation.validator.ExistingDirectoryPathConstraintValidator;
...
/**
 * The annotated element must be a {@link Path} that references to existing directory.
 *
 * @author nedis
 * @see ExistingDirectoryPathConstraintValidator
 * @see ExistingFile
 * @see ExistingPath
 * @since 0.12
 */
