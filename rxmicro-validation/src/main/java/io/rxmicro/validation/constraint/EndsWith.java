...
import io.rxmicro.validation.validator.EndsWithConstraintValidator;
 ...
 *
 * @author nedis
 * @see EndsWithConstraintValidator
 * @since 0.1
 */
@Documented
@Retention(RUNTIME)
...
@ConstraintRule(
        ...
        validatorClasses = EndsWithConstraintValidator.class
)
...
public @interface EndsWith {
     ...
     *
     * @return the required suffix for the field value.
     */
    String value();
}
