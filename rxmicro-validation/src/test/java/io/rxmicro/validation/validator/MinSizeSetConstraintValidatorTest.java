...
final class MinSizeSetConstraintValidatorTest extends AbstractNullableConstraintValidatorTest<Set<?>> {
    ...
    void Should_process_parameter_as_a_valid_one() {
        assertDoesNotThrow(() -> validator.validate(Set.of(1, 2, 3, 4), PARAMETER, FIELD_NAME));
    }
