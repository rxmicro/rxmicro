...
final class MaxSizeSetConstraintValidatorTest extends AbstractConstraintValidatorTest<Set<?>> {
    ...
    void Should_process_parameter_as_a_valid_one() {
        assertDoesNotThrow(() -> validator.validate(Set.of(1, 2), PARAMETER, "value"));
    }
