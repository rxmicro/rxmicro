...
final class RequiredSetConstraintValidatorTest {
    ...
    void Should_process_parameter_as_a_valid_one() {
        assertDoesNotThrow(() -> validator.validate(Set.of("item"), PARAMETER, FIELD_NAME));
    }
    ...
    void Should_throw_ConstraintViolationException() {
        final ConstraintViolationException exception =
                assertThrows(ConstraintViolationException.class, () -> validator.validate(Set.of(), PARAMETER, FIELD_NAME));
        assertEquals(
