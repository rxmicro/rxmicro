...
final class RequiredMapConstraintValidatorTest {
    ...
    void Should_process_parameter_as_a_valid_one() {
        assertDoesNotThrow(() -> validator.validate(Map.of("key", FIELD_NAME), PARAMETER, FIELD_NAME));
    }
    ...
    void Should_throw_ConstraintViolationException() {
        final ConstraintViolationException exception =
                assertThrows(ConstraintViolationException.class, () -> validator.validate(Map.of(), PARAMETER, FIELD_NAME));
        assertEquals(
