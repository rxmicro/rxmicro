...
final class RequiredMapConstraintValidatorTest extends AbstractConstraintValidatorTest {
    ...
    void Should_throw_ConstraintViolationException() {
        final ConstraintViolationException exception =
                assertThrows(ConstraintViolationException.class, () -> validator.validate(Map.of(), PARAMETER, "value"));
        assertEquals(
