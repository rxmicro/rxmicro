...
final class MinByteConstraintValidatorTest extends AbstractNullableConstraintValidatorTest<Byte> {
    ...
    void Should_process_parameter_as_a_valid_one() {
        assertDoesNotThrow(() -> validator.validate((byte) 10, PARAMETER, FIELD_NAME));
    }
    ...
    void Should_throw_ConstraintViolationException() {
        final ConstraintViolationException exception =
                assertThrows(ConstraintViolationException.class, () -> validator.validate((byte) 1, PARAMETER, FIELD_NAME));
        assertEquals(
