...
final class MaxShortConstraintValidatorTest extends AbstractNullableConstraintValidatorTest<Short> {
    ...
    void Should_process_parameter_as_a_valid_one() {
        assertDoesNotThrow(() -> validator.validate((short) 8, PARAMETER, FIELD_NAME));
    }
    ...
    void Should_throw_ConstraintViolationException() {
        final ConstraintViolationException exception =
                assertThrows(ConstraintViolationException.class, () -> validator.validate((short) 100, PARAMETER, FIELD_NAME));
        assertEquals(
