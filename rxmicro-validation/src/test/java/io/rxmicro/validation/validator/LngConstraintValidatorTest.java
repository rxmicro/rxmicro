...
final class LngConstraintValidatorTest extends AbstractConstraintValidatorTest<BigDecimal> {
    ...
    void Should_throw_ValidationException(final String value,
        ...
        final ValidationException exception =
                assertThrows(ValidationException.class, () -> validator.validate(new BigDecimal(value), PARAMETER, "lng"));
        assertEquals(
