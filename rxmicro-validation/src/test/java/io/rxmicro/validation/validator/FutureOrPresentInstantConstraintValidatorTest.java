...
final class FutureOrPresentInstantConstraintValidatorTest extends AbstractNullableConstraintValidatorTest<Instant> {
    ...
    void Should_throw_ConstraintViolationException() {
        ...
        {
            final String requiredFragment = "Invalid parameter \"fieldName\": Expected a future or present instant, but actual is ";
            assertTrue(
