...
final class UniqueItemsConstraintValidatorTest extends AbstractConstraintValidatorTest<List<?>> {

    @Override
    ConstraintValidator<List<?>> instantiate() {
        return new UniqueItemsConstraintValidator();
    }
    ...
    void Should_throw_ValidationException(final String value) {
        ...
        assertEquals(
                format("Invalid parameter \"value\": Expected unique items, but actual is '?'!", list),
