...
final class MaxDoubleConstraintValidatorTest extends AbstractNullableConstraintValidatorTest<Double> {
    ...
    void Should_process_parameter_as_a_valid_one() {
        assertDoesNotThrow(() -> validator.validate(8.0, PARAMETER, FIELD_NAME));
    }
    ...
    void Should_throw_ConstraintViolationException() {
        final ConstraintViolationException exception =
                assertThrows(ConstraintViolationException.class, () -> validator.validate(100.0, PARAMETER, FIELD_NAME));
        assertEquals(
