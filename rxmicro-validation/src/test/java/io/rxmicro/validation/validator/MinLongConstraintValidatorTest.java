...
final class MinLongConstraintValidatorTest extends AbstractNullableConstraintValidatorTest<Long> {

    @Override
    ConstraintValidator<Long> instantiate() {
        return new MinLongConstraintValidator(5L, true);
    }

    @Test
    @Order(11)
    void Should_process_parameter_as_a_valid_one() {
        assertDoesNotThrow(() -> validator.validate(10L, PARAMETER, FIELD_NAME));
    }
