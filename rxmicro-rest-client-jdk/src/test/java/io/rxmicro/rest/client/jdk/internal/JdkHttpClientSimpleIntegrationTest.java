...
@SuppressWarnings({"PMD.FieldDeclarationsShouldBeAtStartOfClass", "PMD.AvoidDuplicateLiterals"})
final class JdkHttpClientSimpleIntegrationTest {

    private static final int HTTP_PORT = 9085;
    ...
    void Should_send_without_body_and_without_custom_headers_successfully() {
        ...
        try {
            final HttpResponse response = jdkHttpClient.sendAsync("GET", "/test", List.of()).join();
    ...
    void Should_send_with_body_and_without_custom_headers_successfully() {
        ...
        try {
            final HttpResponse response = jdkHttpClient.sendAsync("POST", "/test", List.of(), TEST_CONTENT_DATA).join();
    ...
    void Should_send_without_body_and_with_custom_headers_successfully() {
        ...
        try {
            ...
            final HttpResponse response = jdkHttpClient.sendAsync("GET", "/test", headers.getEntries()).join();
    ...
    void Should_send_with_body_and_with_custom_headers_successfully() {
        ...
        try {
            ...
            final HttpResponse response = jdkHttpClient.sendAsync("POST", "/test", headers.getEntries(), TEST_CONTENT_DATA).join();
    ...
    void Should_throw_IllegalArgumentException_if_restricted_header_detected(final String header) {
        final IllegalArgumentException exception =
                assertThrows(IllegalArgumentException.class, () ->
                        jdkHttpClient.sendAsync("GET", "/", List.of(entry(header, "value"))));
        assertEquals(format("restricted header name: \"?\"", header), exception.getMessage());
    }
