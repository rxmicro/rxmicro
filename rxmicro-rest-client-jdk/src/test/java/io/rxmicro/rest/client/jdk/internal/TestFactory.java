...
final class TestFactory {
     ...
     * @since 0.8
     */
    static final class TestHttpClientContentConverter implements HttpClientContentConverter {
     ...
     * @since 0.8
     */
    static class TestAbstractLogger extends AbstractLogger {

        private final Map<Level, Boolean> levelEnabledMap;

        public TestAbstractLogger(final Map<Level, Boolean> levelEnabledMap) {
