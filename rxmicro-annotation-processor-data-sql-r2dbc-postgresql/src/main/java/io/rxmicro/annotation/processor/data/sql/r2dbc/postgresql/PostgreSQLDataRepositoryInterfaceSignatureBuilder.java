 ...
 */
@Singleton
public final class PostgreSQLDataRepositoryInterfaceSignatureBuilder extends AbstractDataRepositoryInterfaceSignatureBuilder {

    @Override
    protected Class<? extends Annotation> getRepositoryMarkerAnnotationClass() {
        return PostgreSQLRepository.class;
    }
    ...
    protected Class<?> getDefaultAbstractClass() {
        return AbstractPostgreSQLRepository.class;
    }
}
