package rxmicro.examples.data.r2dbc.postgresql.request.id.supplier;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.data.r2dbc.postgresql.request.id.supplier", RX_MICRO_REFLECTION_MODULE);
    }
