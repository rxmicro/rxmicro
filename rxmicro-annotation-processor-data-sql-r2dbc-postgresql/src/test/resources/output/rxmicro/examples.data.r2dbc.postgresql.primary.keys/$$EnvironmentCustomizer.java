package rxmicro.examples.data.r2dbc.postgresql.primary.keys;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.data.r2dbc.postgresql.primary.keys", RX_MICRO_REFLECTION_MODULE);
    }
