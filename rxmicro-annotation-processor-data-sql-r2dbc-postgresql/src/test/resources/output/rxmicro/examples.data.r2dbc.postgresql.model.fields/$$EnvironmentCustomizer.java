package rxmicro.examples.data.r2dbc.postgresql.model.fields;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.data.r2dbc.postgresql.model.fields", RX_MICRO_REFLECTION_MODULE);
    }
