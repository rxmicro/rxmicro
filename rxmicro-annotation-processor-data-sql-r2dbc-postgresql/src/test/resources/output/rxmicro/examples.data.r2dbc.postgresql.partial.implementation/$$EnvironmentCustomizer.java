package rxmicro.examples.data.r2dbc.postgresql.partial.implementation;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.data.r2dbc.postgresql.partial.implementation", RX_MICRO_REFLECTION_MODULE);
    }
