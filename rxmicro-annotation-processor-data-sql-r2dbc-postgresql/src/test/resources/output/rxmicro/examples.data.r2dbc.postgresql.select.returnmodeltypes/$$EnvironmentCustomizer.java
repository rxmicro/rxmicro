package rxmicro.examples.data.r2dbc.postgresql.select.returnmodeltypes;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.data.r2dbc.postgresql.select.returnmodeltypes", RX_MICRO_REFLECTION_MODULE);
    }
