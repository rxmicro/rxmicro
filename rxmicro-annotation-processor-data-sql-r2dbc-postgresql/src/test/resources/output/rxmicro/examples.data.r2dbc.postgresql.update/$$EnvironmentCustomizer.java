package rxmicro.examples.data.r2dbc.postgresql.update;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.data.r2dbc.postgresql.update", RX_MICRO_REFLECTION_MODULE);
    }
