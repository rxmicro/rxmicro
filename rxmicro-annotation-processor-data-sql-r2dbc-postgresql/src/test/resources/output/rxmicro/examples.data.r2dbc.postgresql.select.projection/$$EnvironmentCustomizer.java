package rxmicro.examples.data.r2dbc.postgresql.select.projection;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.data.r2dbc.postgresql.select.projection", RX_MICRO_REFLECTION_MODULE);
    }
