package rxmicro.examples.data.r2dbc.postgresql.select.returnreactivetypes;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.data.r2dbc.postgresql.select.returnreactivetypes", RX_MICRO_REFLECTION_MODULE);
    }
