package rxmicro.examples.data.r2dbc.postgresql.insert;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.data.r2dbc.postgresql.insert", RX_MICRO_REFLECTION_MODULE);
    }
