package rxmicro.examples.data.r2dbc.postgresql.select.custom;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.data.r2dbc.postgresql.select.custom", RX_MICRO_REFLECTION_MODULE);
    }
