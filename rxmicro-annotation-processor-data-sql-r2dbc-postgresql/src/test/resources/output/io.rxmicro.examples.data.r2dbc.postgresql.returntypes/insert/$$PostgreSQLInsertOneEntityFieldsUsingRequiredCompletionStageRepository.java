...
public final class $$PostgreSQLInsertOneEntityFieldsUsingRequiredCompletionStageRepository extends AbstractPostgreSQLRepository implements InsertOneEntityFieldsUsingRequiredCompletionStageRepository {
    ...
    public $$PostgreSQLInsertOneEntityFieldsUsingRequiredCompletionStageRepository(final ConnectionPool pool) {
        super(InsertOneEntityFieldsUsingRequiredCompletionStageRepository.class);
        this.connectionFactory = new RepositoryConnectionPool(InsertOneEntityFieldsUsingRequiredCompletionStageRepository.class, pool);
    }
