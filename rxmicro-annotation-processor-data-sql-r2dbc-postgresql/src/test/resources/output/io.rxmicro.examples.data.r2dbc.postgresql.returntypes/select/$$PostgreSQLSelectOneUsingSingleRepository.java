 ...
 */
public final class $$PostgreSQLSelectOneUsingSingleRepository extends AbstractPostgreSQLRepository implements SelectOneUsingSingleRepository {
    ...
    @Override
    public Single<EntityFieldMap> find02() {
        // Original SQL statement:  'SELECT first_name, last_name FROM ${table} WHERE email = 'richard.hendricks@piedpiper.com''
        final String generatedSQL = "SELECT first_name, last_name FROM account WHERE email = 'richard.hendricks@piedpiper.com'";
        return Single.fromPublisher(
                pool.create()
    ...
    @Override
    public Single<EntityFieldList> find03() {
        // Original SQL statement:  'SELECT first_name, last_name FROM ${table} WHERE email = 'richard.hendricks@piedpiper.com''
        final String generatedSQL = "SELECT first_name, last_name FROM account WHERE email = 'richard.hendricks@piedpiper.com'";
        return Single.fromPublisher(
                pool.create()
    ...
    @Override
    public Single<BigDecimal> find06() {
