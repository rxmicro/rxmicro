...
public interface UpdateManyUsingSingleListRepository {

    @Update("UPDATE ${table} SET first_name='Russ', last_name='Hanneman' RETURNING *")
    Single<List<Account>> updateAll01();

    @Update("UPDATE ${table} SET first_name='Russ', last_name='Hanneman' RETURNING first_name, last_name")
    Single<List<EntityFieldMap>> updateAll02();

    @Update("UPDATE ${table} SET first_name='Russ', last_name='Hanneman' RETURNING first_name, last_name")
    Single<List<EntityFieldList>> updateAll03();
}
