...
public interface UpdateManyUsingCompletableFutureListRepository {

    @Update("UPDATE ${table} SET first_name='Russ', last_name='Hanneman' RETURNING *")
    CompletableFuture<List<Account>> updateAll01();

    @Update("UPDATE ${table} SET first_name='Russ', last_name='Hanneman' RETURNING first_name, last_name")
    CompletableFuture<List<EntityFieldMap>> updateAll02();

    @Update("UPDATE ${table} SET first_name='Russ', last_name='Hanneman' RETURNING first_name, last_name")
    CompletableFuture<List<EntityFieldList>> updateAll03();
}
