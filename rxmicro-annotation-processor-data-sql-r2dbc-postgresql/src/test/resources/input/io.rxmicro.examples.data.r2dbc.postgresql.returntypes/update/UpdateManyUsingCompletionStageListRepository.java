...
public interface UpdateManyUsingCompletionStageListRepository {

    @Update("UPDATE ${table} SET first_name='Russ', last_name='Hanneman' RETURNING *")
    CompletionStage<List<Account>> updateAll01();

    @Update("UPDATE ${table} SET first_name='Russ', last_name='Hanneman' RETURNING first_name, last_name")
    CompletionStage<List<EntityFieldMap>> updateAll02();

    @Update("UPDATE ${table} SET first_name='Russ', last_name='Hanneman' RETURNING first_name, last_name")
    CompletionStage<List<EntityFieldList>> updateAll03();
}
