...
public interface UpdateOneEntityFieldsUsingMonoRepository {
    ...
    Mono<Account> update04(String firstName, String lastName, Long id);

    @Update("UPDATE ${table} SET first_name=?, last_name=? WHERE id=? RETURNING first_name, last_name")
    Mono<EntityFieldMap> update05(String firstName, String lastName, Long id);

    @Update("UPDATE ${table} SET first_name=?, last_name=? WHERE id=? RETURNING first_name, last_name")
    Mono<EntityFieldList> update06(String firstName, String lastName, Long id);
}
