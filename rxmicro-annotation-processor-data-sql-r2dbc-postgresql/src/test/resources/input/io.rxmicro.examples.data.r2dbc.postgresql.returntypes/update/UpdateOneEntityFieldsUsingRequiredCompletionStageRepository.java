...
public interface UpdateOneEntityFieldsUsingRequiredCompletionStageRepository {
    ...
    CompletionStage<Account> update04(String firstName, String lastName, Long id);

    @Update("UPDATE ${table} SET first_name=?, last_name=? WHERE id=? RETURNING first_name, last_name")
    CompletionStage<EntityFieldMap> update05(String firstName, String lastName, Long id);

    @Update("UPDATE ${table} SET first_name=?, last_name=? WHERE id=? RETURNING first_name, last_name")
    CompletionStage<EntityFieldList> update06(String firstName, String lastName, Long id);
}
