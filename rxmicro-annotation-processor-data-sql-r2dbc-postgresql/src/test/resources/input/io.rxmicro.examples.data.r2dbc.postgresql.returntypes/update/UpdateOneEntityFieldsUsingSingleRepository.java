...
public interface UpdateOneEntityFieldsUsingSingleRepository {
    ...
    Single<Account> update03(String firstName, String lastName, Long id);

    @Update("UPDATE ${table} SET first_name=?, last_name=? WHERE id=? RETURNING first_name, last_name")
    Single<EntityFieldMap> update04(String firstName, String lastName, Long id);

    @Update("UPDATE ${table} SET first_name=?, last_name=? WHERE id=? RETURNING first_name, last_name")
    Single<EntityFieldList> update05(String firstName, String lastName, Long id);
}
