...
public interface SelectManyUsingSingleListRepository {

    @Select("SELECT first_name, last_name FROM ${table} ORDER BY id")
    Single<List<Account>> findAll01();

    @Select("SELECT first_name, last_name FROM ${table} ORDER BY id")
    Single<List<EntityFieldMap>> findAll02();

    @Select("SELECT first_name, last_name FROM ${table} ORDER BY id")
    Single<List<EntityFieldList>> findAll03();
    ...
    Single<List<BigDecimal>> findAll06();
}
