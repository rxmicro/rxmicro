...
public interface InsertManyUsingSingleListRepository {

    @Insert("INSERT INTO ${table} SELECT * FROM dump RETURNING *")
    Single<List<Account>> insertAll01();

    @Insert("INSERT INTO ${table} SELECT * FROM dump RETURNING first_name, last_name")
    Single<List<EntityFieldMap>> insertAll02();

    @Insert("INSERT INTO ${table} SELECT * FROM dump RETURNING first_name, last_name")
    Single<List<EntityFieldList>> insertAll03();
}
