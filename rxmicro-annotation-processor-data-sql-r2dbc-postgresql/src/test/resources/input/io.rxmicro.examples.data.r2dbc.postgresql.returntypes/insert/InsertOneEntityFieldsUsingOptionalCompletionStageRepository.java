...
public interface InsertOneEntityFieldsUsingOptionalCompletionStageRepository {

    @Insert("INSERT INTO ${table}(first_name, last_name) VALUES(?,?) ON CONFLICT DO NOTHING RETURNING *")
    CompletionStage<Optional<Account>> insert01(String firstName, String lastName);

    @Insert("INSERT INTO ${table}(first_name, last_name) VALUES(?,?) ON CONFLICT DO NOTHING RETURNING first_name, last_name")
    CompletionStage<Optional<EntityFieldMap>> insert02(String firstName, String lastName);

    @Insert("INSERT INTO ${table}(first_name, last_name) VALUES(?,?) ON CONFLICT DO NOTHING RETURNING first_name, last_name")
    CompletionStage<Optional<EntityFieldList>> insert03(String firstName, String lastName);
}
