...
public interface InsertManyUsingCompletionStageListRepository {

    @Insert("INSERT INTO ${table} SELECT * FROM dump RETURNING *")
    CompletionStage<List<Account>> insertAll01();

    @Insert("INSERT INTO ${table} SELECT * FROM dump RETURNING first_name, last_name")
    CompletionStage<List<EntityFieldMap>> insertAll02();

    @Insert("INSERT INTO ${table} SELECT * FROM dump RETURNING first_name, last_name")
    CompletionStage<List<EntityFieldList>> insertAll03();
}
