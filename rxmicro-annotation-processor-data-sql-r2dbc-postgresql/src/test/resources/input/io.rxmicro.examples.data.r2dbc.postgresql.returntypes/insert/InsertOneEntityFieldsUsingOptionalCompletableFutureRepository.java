...
public interface InsertOneEntityFieldsUsingOptionalCompletableFutureRepository {

    @Insert("INSERT INTO ${table}(first_name, last_name) VALUES(?,?) ON CONFLICT DO NOTHING RETURNING *")
    CompletableFuture<Optional<Account>> insert01(String firstName, String lastName);

    @Insert("INSERT INTO ${table}(first_name, last_name) VALUES(?,?) ON CONFLICT DO NOTHING RETURNING first_name, last_name")
    CompletableFuture<Optional<EntityFieldMap>> insert02(String firstName, String lastName);

    @Insert("INSERT INTO ${table}(first_name, last_name) VALUES(?,?) ON CONFLICT DO NOTHING RETURNING first_name, last_name")
    CompletableFuture<Optional<EntityFieldList>> insert03(String firstName, String lastName);
}
