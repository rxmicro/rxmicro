...
public interface InsertManyUsingCompletableFutureListRepository {

    @Insert("INSERT INTO ${table} SELECT * FROM dump RETURNING *")
    CompletableFuture<List<Account>> insertAll01();

    @Insert("INSERT INTO ${table} SELECT * FROM dump RETURNING first_name, last_name")
    CompletableFuture<List<EntityFieldMap>> insertAll02();

    @Insert("INSERT INTO ${table} SELECT * FROM dump RETURNING first_name, last_name")
    CompletableFuture<List<EntityFieldList>> insertAll03();
}
