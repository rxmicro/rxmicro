...
public interface DeleteOneEntityFieldsUsingOptionalCompletionStageRepository {

    @Delete("DELETE FROM ${table} WHERE id=? RETURNING *")
    CompletionStage<Optional<Account>> delete01(Long id);

    @Delete("DELETE FROM ${table} WHERE id=? RETURNING first_name, last_name")
    CompletionStage<Optional<EntityFieldMap>> delete02(Long id);

    @Delete("DELETE FROM ${table} WHERE id=? RETURNING first_name, last_name")
    CompletionStage<Optional<EntityFieldList>> delete03(Long id);
}
