...
public final class $$RequestConstraintValidator implements ConstraintValidator<Request> {
    ...
    public void validateNonNull(final Request model,
        ...
        notEmptyStringConstraintValidator.validate(model.getRequestIdHeader(), HttpModelType.HEADER, "Request-Id");

        requiredListConstraintValidator.validate(model.getRepeatingEnumHeaderList(), HttpModelType.HEADER, "repeatingEnumHeaderList");
        requiredConstraintValidator.validateIterable(model.getRepeatingEnumHeaderList(), HttpModelType.HEADER, "repeatingEnumHeaderList");

        requiredSetConstraintValidator.validate(model.getRepeatingEnumHeaderSet(), HttpModelType.HEADER, "repeatingEnumHeaderSet");
        requiredConstraintValidator.validateIterable(model.getRepeatingEnumHeaderSet(), HttpModelType.HEADER, "repeatingEnumHeaderSet");
    }
}
