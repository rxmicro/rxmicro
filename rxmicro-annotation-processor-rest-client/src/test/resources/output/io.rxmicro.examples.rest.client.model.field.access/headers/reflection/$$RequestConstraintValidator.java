...
public final class $$RequestConstraintValidator implements ConstraintValidator<Request> {
    ...
    public void validateNonNull(final Request model,
        ...
        requiredConstraintValidator.validate((io.rxmicro.examples.rest.client.model.field.access.Status) getFieldValue(model, "enumHeader"), HttpModelType.HEADER, "enumHeader");
        ...
        requiredListConstraintValidator.validate((java.util.List<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "enumHeaderList"), HttpModelType.HEADER, "enumHeaderList");
        requiredConstraintValidator.validateIterable((java.util.List<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "enumHeaderList"), HttpModelType.HEADER, "enumHeaderList");
        ...
        requiredSetConstraintValidator.validate((java.util.Set<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "enumHeaderSet"), HttpModelType.HEADER, "enumHeaderSet");
        requiredConstraintValidator.validateIterable((java.util.Set<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "enumHeaderSet"), HttpModelType.HEADER, "enumHeaderSet");

        notEmptyStringConstraintValidator.validate((java.lang.String) getFieldValue(model, "requestIdHeader"), HttpModelType.HEADER, "Request-Id");

        requiredListConstraintValidator.validate((java.util.List<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "repeatingEnumHeaderList"), HttpModelType.HEADER, "repeatingEnumHeaderList");
        requiredConstraintValidator.validateIterable((java.util.List<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "repeatingEnumHeaderList"), HttpModelType.HEADER, "repeatingEnumHeaderList");

        requiredSetConstraintValidator.validate((java.util.Set<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "repeatingEnumHeaderSet"), HttpModelType.HEADER, "repeatingEnumHeaderSet");
        requiredConstraintValidator.validateIterable((java.util.Set<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "repeatingEnumHeaderSet"), HttpModelType.HEADER, "repeatingEnumHeaderSet");
    }
}
