...
public final class $$VirtualVirtualHeadersRequestConstraintValidator implements ConstraintValidator<$$VirtualVirtualHeadersRequest> {
    ...
    public void validateNonNull(final $$VirtualVirtualHeadersRequest model,
        ...
        requiredListConstraintValidator.validate(model.repeatingEnumHeaderList, HttpModelType.HEADER, "Repeating-Enum-Header-List");
        requiredConstraintValidator.validateIterable(model.repeatingEnumHeaderList, HttpModelType.HEADER, "Repeating-Enum-Header-List");

        requiredSetConstraintValidator.validate(model.repeatingEnumHeaderSet, HttpModelType.HEADER, "Repeating-Enum-Header-Set");
        requiredConstraintValidator.validateIterable(model.repeatingEnumHeaderSet, HttpModelType.HEADER, "Repeating-Enum-Header-Set");
    }
}
