...
public final class $$QueryRequestConstraintValidator implements ConstraintValidator<QueryRequest> {
    ...
    public void validateNonNull(final QueryRequest model,
        ...
        requiredListConstraintValidator.validate(model.repeatingEnumParameterList, HttpModelType.PARAMETER, "repeatingEnumParameterList");
        requiredConstraintValidator.validateIterable(model.repeatingEnumParameterList, HttpModelType.PARAMETER, "repeatingEnumParameterList");

        requiredSetConstraintValidator.validate(model.repeatingEnumParameterSet, HttpModelType.PARAMETER, "repeatingEnumParameterSet");
        requiredConstraintValidator.validateIterable(model.repeatingEnumParameterSet, HttpModelType.PARAMETER, "repeatingEnumParameterSet");
    }
}
