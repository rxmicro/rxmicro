 ...
 */
public final class $$VirtualVirtualParamsRequestConstraintValidator implements ConstraintValidator<$$VirtualVirtualParamsRequest> {
    ...
    @Override
    public void validateNonNull(final $$VirtualVirtualParamsRequest model,
        ...
        requiredListConstraintValidator.validate(model.repeatingStatuses, HttpModelType.PARAMETER, "repeatingStatuses");
        requiredConstraintValidator.validateIterable(model.repeatingStatuses, HttpModelType.PARAMETER, "repeatingStatuses");

        requiredSetConstraintValidator.validate(model.repeatingStatusSet, HttpModelType.PARAMETER, "repeatingStatusSet");
        requiredConstraintValidator.validateIterable(model.repeatingStatusSet, HttpModelType.PARAMETER, "repeatingStatusSet");
    }
}
