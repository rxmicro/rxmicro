...
import io.rxmicro.examples.rest.client.model.field.access.params.direct.nested.$$NestedModelToJsonConverter;
 ...
 */
public final class $$VirtualVirtualParamsRequest2ModelToJsonConverter extends ModelToJsonConverter<$$VirtualVirtualParamsRequest2> {

    private final $$NestedModelToJsonConverter nestedModelToJsonConverter =
            new $$NestedModelToJsonConverter();

    @Override
    public Map<String, Object> toJsonObject(final $$VirtualVirtualParamsRequest2 model) {
