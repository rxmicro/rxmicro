...
import io.rxmicro.examples.rest.client.model.field.access.params.reflection.nested.$$NestedConstraintValidator;
...
public final class $$BodyRequestConstraintValidator implements ConstraintValidator<BodyRequest> {
    ...
    public void validateNonNull(final BodyRequest model,
        ...
        requiredConstraintValidator.validate((io.rxmicro.examples.rest.client.model.field.access.Status) getFieldValue(model, "enumParameter"), HttpModelType.PARAMETER, "enumParameter");
        ...
        requiredListConstraintValidator.validate((java.util.List<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "enumParameterList"), HttpModelType.PARAMETER, "enumParameterList");
        requiredConstraintValidator.validateIterable((java.util.List<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "enumParameterList"), HttpModelType.PARAMETER, "enumParameterList");
        ...
        requiredSetConstraintValidator.validate((java.util.Set<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "enumParameterSet"), HttpModelType.PARAMETER, "enumParameterSet");
        requiredConstraintValidator.validateIterable((java.util.Set<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "enumParameterSet"), HttpModelType.PARAMETER, "enumParameterSet");
        ...
        requiredMapConstraintValidator.validate((java.util.Map<java.lang.String,io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "enumParameterMap"), HttpModelType.PARAMETER, "enumParameterMap");
        requiredConstraintValidator.validateMapValues((java.util.Map<java.lang.String,io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "enumParameterMap"), HttpModelType.PARAMETER, "enumParameterMap");

        requiredConstraintValidator.validate((io.rxmicro.examples.rest.client.model.field.access.params.reflection.nested.Nested) getFieldValue(model, "nested"), HttpModelType.PARAMETER, "nested");
        nestedConstraintValidator.validate((io.rxmicro.examples.rest.client.model.field.access.params.reflection.nested.Nested) getFieldValue(model, "nested"), HttpModelType.PARAMETER, "nested");

        requiredListConstraintValidator.validate((java.util.List<io.rxmicro.examples.rest.client.model.field.access.params.reflection.nested.Nested>) getFieldValue(model, "nestedList"), HttpModelType.PARAMETER, "nestedList");
        requiredConstraintValidator.validateIterable((java.util.List<io.rxmicro.examples.rest.client.model.field.access.params.reflection.nested.Nested>) getFieldValue(model, "nestedList"), HttpModelType.PARAMETER, "nestedList");
        nestedConstraintValidator.validateIterable((java.util.List<io.rxmicro.examples.rest.client.model.field.access.params.reflection.nested.Nested>) getFieldValue(model, "nestedList"), HttpModelType.PARAMETER, "nestedList");

        requiredSetConstraintValidator.validate((java.util.Set<io.rxmicro.examples.rest.client.model.field.access.params.reflection.nested.Nested>) getFieldValue(model, "nestedSet"), HttpModelType.PARAMETER, "nestedSet");
        requiredConstraintValidator.validateIterable((java.util.Set<io.rxmicro.examples.rest.client.model.field.access.params.reflection.nested.Nested>) getFieldValue(model, "nestedSet"), HttpModelType.PARAMETER, "nestedSet");
        nestedConstraintValidator.validateIterable((java.util.Set<io.rxmicro.examples.rest.client.model.field.access.params.reflection.nested.Nested>) getFieldValue(model, "nestedSet"), HttpModelType.PARAMETER, "nestedSet");

        requiredMapConstraintValidator.validate((java.util.Map<java.lang.String,io.rxmicro.examples.rest.client.model.field.access.params.reflection.nested.Nested>) getFieldValue(model, "nestedParameterMap"), HttpModelType.PARAMETER, "nestedParameterMap");
        requiredConstraintValidator.validateMapValues((java.util.Map<java.lang.String,io.rxmicro.examples.rest.client.model.field.access.params.reflection.nested.Nested>) getFieldValue(model, "nestedParameterMap"), HttpModelType.PARAMETER, "nestedParameterMap");
        nestedConstraintValidator.validateMapValues((java.util.Map<java.lang.String,io.rxmicro.examples.rest.client.model.field.access.params.reflection.nested.Nested>) getFieldValue(model, "nestedParameterMap"), HttpModelType.PARAMETER, "nestedParameterMap");
    }
}
