...
public final class $$QueryRequestConstraintValidator implements ConstraintValidator<QueryRequest> {
    ...
    public void validateNonNull(final QueryRequest model,
        ...
        requiredListConstraintValidator.validate((java.util.List<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "repeatingEnumParameterList"), HttpModelType.PARAMETER, "repeatingEnumParameterList");
        requiredConstraintValidator.validateIterable((java.util.List<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "repeatingEnumParameterList"), HttpModelType.PARAMETER, "repeatingEnumParameterList");

        requiredSetConstraintValidator.validate((java.util.Set<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "repeatingEnumParameterSet"), HttpModelType.PARAMETER, "repeatingEnumParameterSet");
        requiredConstraintValidator.validateIterable((java.util.Set<io.rxmicro.examples.rest.client.model.field.access.Status>) getFieldValue(model, "repeatingEnumParameterSet"), HttpModelType.PARAMETER, "repeatingEnumParameterSet");
    }
}
