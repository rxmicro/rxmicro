...
public final class $$RestClientWithoutBody extends AbstractRestClient implements RestClientWithoutBody {
    ...
    private final $$VirtualWithoutBodyRequest4ConstraintValidator virtualWithoutBodyRequest4ConstraintValidator =
            new $$VirtualWithoutBodyRequest4ConstraintValidator();

    private final $$VirtualWithoutBodyRequest3ConstraintValidator virtualWithoutBodyRequest3ConstraintValidator =
            new $$VirtualWithoutBodyRequest3ConstraintValidator();

    private final $$VirtualWithoutBodyRequest2ConstraintValidator virtualWithoutBodyRequest2ConstraintValidator =
            new $$VirtualWithoutBodyRequest2ConstraintValidator();

    private final $$VirtualWithoutBodyRequestConstraintValidator virtualWithoutBodyRequestConstraintValidator =
            new $$VirtualWithoutBodyRequestConstraintValidator();
    ...
    public CompletableFuture<Void> completedFuture3(final String requestParameter) {
        ...
        validateRequest(config.isEnableAdditionalValidations(), virtualWithoutBodyRequestConstraintValidator, virtualRequest);
    ...
    public CompletionStage<Void> completionStage3(final String requestParameter) {
        ...
        validateRequest(config.isEnableAdditionalValidations(), virtualWithoutBodyRequest2ConstraintValidator, virtualRequest);
    ...
    public Mono<Void> mono3(final String requestParameter) {
        ...
        validateRequest(config.isEnableAdditionalValidations(), virtualWithoutBodyRequest3ConstraintValidator, virtualRequest);
    ...
    public Completable completable3(final String requestParameter) {
        ...
        validateRequest(config.isEnableAdditionalValidations(), virtualWithoutBodyRequest4ConstraintValidator, virtualRequest);
