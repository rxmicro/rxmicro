 ...
 */
public final class $$VirtualWithoutBodyRequest2ConstraintValidator implements ConstraintValidator<$$VirtualWithoutBodyRequest2> {
    ...
    @Override
    public void validateNonNull(final $$VirtualWithoutBodyRequest2 model,
