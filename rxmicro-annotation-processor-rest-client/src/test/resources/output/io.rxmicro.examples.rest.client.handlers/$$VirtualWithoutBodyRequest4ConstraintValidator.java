 ...
 */
public final class $$VirtualWithoutBodyRequest4ConstraintValidator implements ConstraintValidator<$$VirtualWithoutBodyRequest4> {
    ...
    @Override
    public void validateNonNull(final $$VirtualWithoutBodyRequest4 model,
