 ...
 */
public final class $$VirtualSimpleUsageRequestConstraintValidator implements ConstraintValidator<$$VirtualSimpleUsageRequest> {
    ...
    @Override
    public void validateNonNull(final $$VirtualSimpleUsageRequest model,
