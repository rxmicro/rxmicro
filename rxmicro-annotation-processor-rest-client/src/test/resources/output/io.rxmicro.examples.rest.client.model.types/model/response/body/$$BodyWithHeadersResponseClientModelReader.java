 ...
 */
public final class $$BodyWithHeadersResponseClientModelReader extends ClientModelReader<BodyWithHeadersResponse> {

    private final $$BodyWithHeadersResponseModelFromJsonConverter bodyWithHeadersResponseModelFromJsonConverter =
            new $$BodyWithHeadersResponseModelFromJsonConverter();

    @Override
    public BodyWithHeadersResponse readSingle(final HttpResponse response) {
        final BodyWithHeadersResponse model = bodyWithHeadersResponseModelFromJsonConverter.fromJsonObject(response.getBody());
