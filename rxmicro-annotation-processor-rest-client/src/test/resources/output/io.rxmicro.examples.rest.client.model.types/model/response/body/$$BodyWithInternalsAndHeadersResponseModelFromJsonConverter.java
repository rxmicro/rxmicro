...
import io.rxmicro.examples.rest.client.model.types.model.nested.$$NestedModelFromJsonConverter;
 ...
 */
public final class $$BodyWithInternalsAndHeadersResponseModelFromJsonConverter extends ModelFromJsonConverter<BodyWithInternalsAndHeadersResponse> {

    private final $$NestedModelFromJsonConverter nestedModelFromJsonConverter =
            new $$NestedModelFromJsonConverter();

    @Override
    public BodyWithInternalsAndHeadersResponse fromJsonObject(final Map<String, Object> params) {
        final BodyWithInternalsAndHeadersResponse model = new BodyWithInternalsAndHeadersResponse();
