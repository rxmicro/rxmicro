 ...
 */
public final class $$BodyOnlyResponseModelFromJsonConverter extends ModelFromJsonConverter<BodyOnlyResponse> {

    private final $$NestedModelFromJsonConverter nestedModelFromJsonConverter =
            new $$NestedModelFromJsonConverter();

    @Override
    public BodyOnlyResponse fromJsonObject(final Map<String, Object> params) {
        final BodyOnlyResponse model = new BodyOnlyResponse();
        readParamsToModel(params, model);
        return model;
    }

    public void readParamsToModel(final Map<String, Object> params,
                                  final BodyOnlyResponse model) {
