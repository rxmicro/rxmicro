 ...
 */
public final class $$BodyWithInternalsResponseModelFromJsonConverter extends ModelFromJsonConverter<BodyWithInternalsResponse> {

    private final $$NestedModelFromJsonConverter nestedModelFromJsonConverter =
            new $$NestedModelFromJsonConverter();

    @Override
    public BodyWithInternalsResponse fromJsonObject(final Map<String, Object> params) {
        final BodyWithInternalsResponse model = new BodyWithInternalsResponse();
