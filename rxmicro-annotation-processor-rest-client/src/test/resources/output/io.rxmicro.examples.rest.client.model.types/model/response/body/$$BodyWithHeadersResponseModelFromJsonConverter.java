 ...
 */
public final class $$BodyWithHeadersResponseModelFromJsonConverter extends ModelFromJsonConverter<BodyWithHeadersResponse> {

    private final $$NestedModelFromJsonConverter nestedModelFromJsonConverter =
            new $$NestedModelFromJsonConverter();

    @Override
    public BodyWithHeadersResponse fromJsonObject(final Map<String, Object> params) {
        final BodyWithHeadersResponse model = new BodyWithHeadersResponse();
