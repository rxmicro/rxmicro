 ...
 */
public final class $$HeadersOnlyRequestRequestModelExtractor extends RequestModelExtractor<HeadersOnlyRequest> {

    @Override
    public void extract(final HeadersOnlyRequest model,
