 ...
 */
public final class $$HttpBodyRequestModelToJsonConverter extends ModelToJsonConverter<HttpBodyRequest> {

    private final $$NestedModelToJsonConverter nestedModelToJsonConverter =
            new $$NestedModelToJsonConverter();

    @Override
    public Map<String, Object> toJsonObject(final HttpBodyRequest model) {
        final JsonObjectBuilder builder = new JsonObjectBuilder();
        putValuesToBuilder(model, builder);
        return builder.build();
    }

    protected void putValuesToBuilder(final HttpBodyRequest model,
