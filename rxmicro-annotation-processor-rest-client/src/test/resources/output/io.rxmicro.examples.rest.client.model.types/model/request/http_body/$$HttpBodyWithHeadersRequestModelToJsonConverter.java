...
import io.rxmicro.examples.rest.client.model.types.model.nested.$$NestedModelToJsonConverter;
 ...
 */
public final class $$HttpBodyWithHeadersRequestModelToJsonConverter extends ModelToJsonConverter<HttpBodyWithHeadersRequest> {

    private final $$NestedModelToJsonConverter nestedModelToJsonConverter =
            new $$NestedModelToJsonConverter();

    @Override
    public Map<String, Object> toJsonObject(final HttpBodyWithHeadersRequest model) {
        final JsonObjectBuilder builder = new JsonObjectBuilder();
        putValuesToBuilder(model, builder);
        return builder.build();
    }

    protected void putValuesToBuilder(final HttpBodyWithHeadersRequest model,
