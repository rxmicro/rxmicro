 ...
 */
public final class $$HeadersOnlyRequestConstraintValidator implements ConstraintValidator<HeadersOnlyRequest> {
    ...
    @Override
    public void validateNonNull(final HeadersOnlyRequest model,
