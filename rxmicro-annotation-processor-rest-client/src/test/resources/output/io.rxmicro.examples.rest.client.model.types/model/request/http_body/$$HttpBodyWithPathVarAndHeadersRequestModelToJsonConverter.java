 ...
 */
public final class $$HttpBodyWithPathVarAndHeadersRequestModelToJsonConverter extends ModelToJsonConverter<HttpBodyWithPathVarAndHeadersRequest> {

    private final $$NestedModelToJsonConverter nestedModelToJsonConverter =
            new $$NestedModelToJsonConverter();

    @Override
    public Map<String, Object> toJsonObject(final HttpBodyWithPathVarAndHeadersRequest model) {
