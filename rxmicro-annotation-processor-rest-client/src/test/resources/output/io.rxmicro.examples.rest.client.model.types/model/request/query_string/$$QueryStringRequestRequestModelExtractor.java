 ...
 */
public final class $$QueryStringRequestRequestModelExtractor extends RequestModelExtractor<QueryStringRequest> {

    @Override
    public void extract(final QueryStringRequest model,
