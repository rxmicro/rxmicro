 ...
 */
public final class $$HttpBodyWithPathVarRequestModelToJsonConverter extends ModelToJsonConverter<HttpBodyWithPathVarRequest> {

    private final $$NestedModelToJsonConverter nestedModelToJsonConverter =
            new $$NestedModelToJsonConverter();

    @Override
    public Map<String, Object> toJsonObject(final HttpBodyWithPathVarRequest model) {
