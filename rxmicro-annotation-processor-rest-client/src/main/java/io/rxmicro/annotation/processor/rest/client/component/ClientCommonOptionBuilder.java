...
public interface ClientCommonOptionBuilder {
    ...
    StaticHeaders getStaticHeaders(ClassHeader.Builder classHeaderBuilder,
                                   Element element,
                                   TypeElement configClass);

    StaticQueryParameters getStaticQueryParameters(ClassHeader.Builder classHeaderBuilder,
                                                   Element element,
                                                   TypeElement configClass);
}
