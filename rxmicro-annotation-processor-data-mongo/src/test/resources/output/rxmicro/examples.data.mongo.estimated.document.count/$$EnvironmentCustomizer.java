package rxmicro.examples.data.mongo.estimated.document.count;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.data.mongo.estimated.document.count", RX_MICRO_REFLECTION_MODULE);
    }
