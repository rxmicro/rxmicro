 ...
 * See <a href="https://www.w3.org/Protocols/rfc2616/rfc2616-sec9.html#sec9.6">
...
public @interface PUT {
    ...
    /**
     * Defines several {@link PUT} annotations on the same element.
     *
     * @author nedis
     * @link https://rxmicro.io
     * @since 0.1
    ...
    @interface List {
        ...
        /**
         * Returns the several {@link PUT} annotations on the same element.
         *
         * @return the several {@link PUT} annotations on the same element.
         */
        PUT[] value();
    }
}
