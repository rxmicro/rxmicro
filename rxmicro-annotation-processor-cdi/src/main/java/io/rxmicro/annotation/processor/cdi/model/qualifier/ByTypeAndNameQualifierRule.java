...
public class ByTypeAndNameQualifierRule extends ByTypeQualifierRule {
    ...
    public ByTypeAndNameQualifierRule(final TypeMirror typeMirror,
                                      final String name) {
        super(typeMirror);
        this.name = require(name);
    }

    public ByTypeAndNameQualifierRule(final TypeElement typeElement,
                                      final String name) {
        super(typeElement);
        this.name = require(name);
    }
    ...
    public String getJavaCodeFragment() {
        return format("new ?<>(?.class, \"?\")",
                ByTypeAndNameInstanceQualifier.class.getSimpleName(),
    ...
    public Set<String> getImports() {
        return Set.of(
                getFullTypeName(),
                ByTypeAndNameInstanceQualifier.class.getName()
        );
    }
}
