package rxmicro.examples.cdi.ambiguty.resolving.impl.classname.and.Named.annotation;
...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.cdi.ambiguty.resolving.impl.classname.and.Named.annotation", RX_MICRO_REFLECTION_MODULE);
    }

    private static void openThePackagesWithModelClassesToReflectionModule() {
        final Module currentModule = $$EnvironmentCustomizer.class.getModule();
        currentModule.addOpens("io.rxmicro.examples.cdi.ambiguty.resolving.impl.classname.named.field", RX_MICRO_REFLECTION_MODULE);
        currentModule.addOpens("io.rxmicro.examples.cdi.ambiguty.resolving.impl.classname.named.field.impl", RX_MICRO_REFLECTION_MODULE);
    }
