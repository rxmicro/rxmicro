...
final class $$EnvironmentCustomizer {
    ...
    private static void exportTheRxmicroPackageToReflectionModule() {
        ...
        currentModule.addExports("rxmicro.examples.cdi.all.user.components", RX_MICRO_REFLECTION_MODULE);
    }

    private static void openThePackagesWithModelClassesToReflectionModule(){
        final Module currentModule = $$EnvironmentCustomizer.class.getModule();
        currentModule.addOpens("io.rxmicro.examples.cdi.all.user.components", RX_MICRO_REFLECTION_MODULE);
        currentModule.addOpens("io.rxmicro.examples.cdi.all.user.components.children", RX_MICRO_REFLECTION_MODULE);
    }
