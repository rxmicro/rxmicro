...
import static rxmicro.examples.cdi.all.rxmicro.components.$$Reflections.invoke;
import static rxmicro.examples.cdi.all.rxmicro.components.$$Reflections.setFieldValue;

/**
 * Generated by {@code RxMicro Annotation Processor}
 */
public final class $$InternalTypesJEEStylePrivateFieldInjectionRestControllerBeanSupplier extends BeanSupplier<InternalTypesJEEStylePrivateFieldInjectionRestController> {

    @Override
    public InternalTypesJEEStylePrivateFieldInjectionRestController get() {
        final InternalTypesJEEStylePrivateFieldInjectionRestController bean = new InternalTypesJEEStylePrivateFieldInjectionRestController();
        ...
        setFieldValue(bean, "restClientConfig", getConfig("rest-client", RestClientConfig.class));
        setFieldValue(bean, "customRestClientConfig", getConfig("custom-rest-client", RestClientConfig.class));
