...
@Named("factoryMethod")
public final class FactoryMethodBusinessService implements BusinessService {

    private final int index;

    @Factory
    static FactoryMethodBusinessService create() {
        return new FactoryMethodBusinessService();
    }

    private FactoryMethodBusinessService() {
