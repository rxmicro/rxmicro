 ...
 * @since 0.10
 */
public final class ModelExceptionErrorResponseAnnotationValueProvider implements AnnotationValueProvider {

    private final ModelExceptionErrorResponse annotation;

    public ModelExceptionErrorResponseAnnotationValueProvider(final ModelExceptionErrorResponse annotation) {
