 ...
 * @since 0.9
 */
abstract class AbstractAuthorAnnotationValueProvider implements AnnotationValueProvider {

    final Author annotation;

    AbstractAuthorAnnotationValueProvider(final Author annotation) {
