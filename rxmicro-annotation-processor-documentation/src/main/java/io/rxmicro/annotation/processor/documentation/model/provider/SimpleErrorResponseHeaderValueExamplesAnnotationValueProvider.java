...
public final class SimpleErrorResponseHeaderValueExamplesAnnotationValueProvider extends AbstractSimpleErrorResponseAnnotationValueProvider {
    ...
    public SimpleErrorResponseHeaderValueExamplesAnnotationValueProvider(final SimpleErrorResponse annotation) {
        super(annotation);
    }

    @Override
    public String getAnnotationValueParameterName() {
        return "headerValueExamples";
    }

    @Override
    public String getValue() {
        return annotation.headerValueExamples()[index++];
    }
}
