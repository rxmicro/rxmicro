 ...
 * @since 0.9
 */
public final class TitleAnnotationValueProvider implements AnnotationValueProvider {

    private final Title annotation;

    public TitleAnnotationValueProvider(final Title annotation) {
