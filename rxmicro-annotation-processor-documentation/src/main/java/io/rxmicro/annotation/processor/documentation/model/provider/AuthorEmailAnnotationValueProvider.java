 ...
 * @since 0.9
 */
public final class AuthorEmailAnnotationValueProvider extends AbstractAuthorAnnotationValueProvider {

    public AuthorEmailAnnotationValueProvider(final Author annotation) {
        super(annotation);
    }
