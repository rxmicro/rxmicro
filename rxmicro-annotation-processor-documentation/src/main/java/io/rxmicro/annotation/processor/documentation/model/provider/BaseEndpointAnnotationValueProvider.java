 ...
 * @since 0.9
 */
public final class BaseEndpointAnnotationValueProvider implements AnnotationValueProvider {

    private final BaseEndpoint annotation;

    public BaseEndpointAnnotationValueProvider(final BaseEndpoint annotation) {
