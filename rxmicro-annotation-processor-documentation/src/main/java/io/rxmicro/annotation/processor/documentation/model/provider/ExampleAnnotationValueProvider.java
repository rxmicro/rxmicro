 ...
 * @since 0.9
 */
public final class ExampleAnnotationValueProvider implements AnnotationValueProvider {

    private final Example annotation;

    public ExampleAnnotationValueProvider(final Example annotation) {
