...
public @interface RestServerGeneratorConfig {
     ...
     *
     * <p>
     * By default generated response validators are not invoked by the REST server.
     * To enable the validation of HTTP responses by the generated validators it is necessary to enable additional validations:
     * {@link RestServerConfig#setEnableAdditionalValidations(boolean)}.
     *
     * <p>
     * Responses validation is useful feature for development environment only, so to enable this feature it is necessary
     * to configure the RxMicro framework manually. (See above how to do it)
     *
     * @see RestServerConfig#isEnableAdditionalValidations()
     * @return {@link GenerateOption#AUTO_DETECT} if validators must be generated only if the developer adds the
     *              {@code rxmicro.validation} module to the {@code module-info.java} descriptor.
     *         {@link GenerateOption#DISABLED} if validators must not be generated by the RxMicro Annotation Processor.
     */
