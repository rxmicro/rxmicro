...
final class BaseRestControllerMethod_Redirect_IntegrationTest extends AbstractBaseRestControllerMethodTest {
    ...
    void Should_throw_Exception_if_User_exception_class_does_not_extend_RedirectException() {
        ...
        assertEquals(InvalidBusinessLogicException.class, exception.getCause().getClass());
        assertEquals(
