...
import static io.rxmicro.annotation.processor.integration.test.ExternalModule.EXTERNAL_JUNIT_JUPITER_PARAMS_MODULE;
import static io.rxmicro.annotation.processor.integration.test.ExternalModule.EXTERNAL_JUNIT_PLATFORM_COMMONS_MODULE;
import static io.rxmicro.annotation.processor.integration.test.ExternalModule.EXTERNAL_MOCKITO_JUNIT_JUPITER_MODULE;
import static io.rxmicro.annotation.processor.integration.test.ExternalModule.EXTERNAL_MOCKITO_MODULE;
...
final class TestFixers_SuccessCompilation_IntegrationTest extends AbstractRxMicroAnnotationProcessorIntegrationTest {
    ...
    void beforeEach() {
        ...
        addExternalModule(EXTERNAL_JUNIT_PLATFORM_COMMONS_MODULE);
        addExternalModule(EXTERNAL_OPENTEST4J_MODULE);
        addExternalModule(EXTERNAL_APIGUARDIAN_API_MODULE);
        addExternalModule(EXTERNAL_MOCKITO_MODULE);
