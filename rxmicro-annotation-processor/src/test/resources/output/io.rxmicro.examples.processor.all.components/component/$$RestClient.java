...
public final class $$RestClient extends AbstractRestClient implements RestClient {
    ...
    private final $$AccountConstraintValidator accountConstraintValidator =
            new $$AccountConstraintValidator();
    ...
    public CompletableFuture<Account> get() {
        ...
        return response
                ...
                .whenComplete((resp, th) -> validateIfResponseExists(accountConstraintValidator, resp));
    }
}
