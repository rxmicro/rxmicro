...
and built using https://rxmicro.io[RxMicro^] framework. +
...
Therefore, in order to unambiguously determine the cause of the error, RxMicro by default uses exactly `HTTP/1.1 400 Bad Request` response in case the handler is absent.
====
...
*The FULL-PROJECT-DOCUMENTATION-* is licensed under the https://github.com/rxmicro/rxmicro-usage/blob/master/examples/LICENSE[MIT License^].
