...
public final class ArrayRestrictionReader extends ConstraintReader {
    ...
    public void read(final Map.Entry<RestModelField, ModelClass> entry,
                     final List<String> restrictions,
                     final List<ReadMore> readMores) {
        final RestModelField annotated = entry.getKey();
        readUsingAnnotationConstraintReader(annotationConstraintReaders, annotated, restrictions, readMores, null);
    }
}
